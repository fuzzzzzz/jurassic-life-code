...
//JL
static ConVar mat_colcorrection_scale( "mat_colcorrection_scale", "1", FCVAR_NONE );
...
void C_ColorCorrection::ClientThink()
{
	...
	g_pColorCorrectionMgr->SetColorCorrectionWeight( m_CCHandle, mat_colcorrection_scale.GetFloat()*m_flCurWeight * ( 1.0 - weight ) );
