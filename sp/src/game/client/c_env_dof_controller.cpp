...
:	m_bDOFEnabled( true ),
	m_flNearBlurDepth( 20.9f ),
	m_flNearFocusDepth( 1.0f ),
	m_flFarFocusDepth( 89.0f ),
	m_flFarBlurDepth( 6.0f ),
	m_flNearBlurRadius( 1.4f ),		// no near blur by default
	m_flFarBlurRadius( 34.1f )
{
}
