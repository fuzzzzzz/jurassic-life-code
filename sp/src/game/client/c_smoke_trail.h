...
class MosquitoEffect : public CSimpleEmitter
{
public:
							MosquitoEffect( const char *pDebugName );
	static MosquitoEffect*		Create( const char *pDebugName );
...
private:
	MosquitoEffect( const MosquitoEffect & );
};
//==================================================
// C_MosquitoParticle
//==================================================

class C_MosquitoParticle : public C_BaseParticleEntity, public IPrototypeAppEffect
{
public:
	DECLARE_CLASS( C_MosquitoParticle, C_BaseParticleEntity );
	DECLARE_CLIENTCLASS();
	
	C_MosquitoParticle( void );
	virtual	~C_MosquitoParticle( void );
...
private:
	C_MosquitoParticle( const C_MosquitoParticle & );
	...
	MosquitoEffect		*m_pMosquitoEffect;
	CParticleMgr		*m_pParticleMgr;
};
