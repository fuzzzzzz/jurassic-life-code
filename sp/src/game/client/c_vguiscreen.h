...
class VGUILuaBind : public LuaBind
{
public:
	VGUILuaBind();

	CVGuiScreenPanel* GetPanel();
	void SetPanel(CVGuiScreenPanel* panel);
protected:
	CVGuiScreenPanel* m_pPanel;
};
...
public:
	...
	{
		//DevMsg("Cursor Moved %d %d\n",x,y);
	}

	virtual void OnMousePressed(vgui::MouseCode code)
	{
		//DevMsg("OnMousePressed\n");
	}
	virtual void OnMouseDoublePressed(vgui::MouseCode code)
	{
		//DevMsg("OnMouseDoublePressed\n");
	}
	virtual void OnMouseReleased(vgui::MouseCode code)
	{
		//DevMsg("OnMouseReleased\n");
	}
	virtual void OnMouseWheeled(int delta)
	{
		//DevMsg("OnMouseWheeled\n");
	}

	// - override to 'swallow' the input
	virtual void OnKeyCodePressed(vgui::KeyCode code)
	{
		DevMsg("OnKeyCodePressed\n");
	}
	virtual void OnKeyCodeTyped(vgui::KeyCode code)
	{
		DevMsg("OnKeyCodeTyped\n");
	}
	...
	{
		DevMsg("OnKeyCodeReleased\n");
	}

	VGUILuaBind& GetLuaBind()
	{
		return m_LuaBind;
	}
...
private:
	...
	int m_iPosY;
public:
	//static CUtlVector<C_VGuiScreen*> m_VguiScreens;
};
