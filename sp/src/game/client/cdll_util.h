...
//JL
//char* strreplace( char* input, char* oldstring, char* newstring );
int strReplace(char *Text,const char *Find,const char *Replace);
char* strreplace(char* input, const char* oldstring, const char* newstring);
char* strfirstreplace(char* input,const char* oldstring, const char* newstring);
