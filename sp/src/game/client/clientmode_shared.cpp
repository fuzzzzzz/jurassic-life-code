...
void ClientModeShared::Init()
{
	...
	//JL
	m_pWeaponSelection = ( CBaseHudWeaponSelection * )GET_HUDELEMENT( CHudJLWeaponSelection );
...
{
	//JL(TH) : Render 3D Models Panels
	for ( int i=0; i < g_ClassInventory.Count(); i++ )
    {
        CInventory *pPanel = g_ClassInventory[i];
		pPanel->PostRenderVGui();
	}
}
