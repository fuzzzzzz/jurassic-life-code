...
//JL : Add jl weapons
STUB_WEAPON_CLASS( weapon_healthkit, WeaponHealthKit, CBaseCombatWeapon );
STUB_WEAPON_CLASS( weapon_healthvial, WeaponHealthVial, CBaseCombatWeapon );
...
//STUB_WEAPON_CLASS( weapon_tazer, WeaponTazer, C_BaseHLBludgeonWeapon );
STUB_WEAPON_CLASS( weapon_tranqualizer, WeaponTranqualizer, C_BaseHLCombatWeapon );
STUB_WEAPON_CLASS( weapon_medusa, WeaponMedusa, C_BaseHLCombatWeapon );
STUB_WEAPON_CLASS( weapon_hands, WeaponHands, C_BaseHLBludgeonWeapon );
STUB_WEAPON_CLASS( weapon_rusticmachete, WeaponMachete, C_BaseHLBludgeonWeapon );
#endif // HL2MP
