...
class C_BaseMastodon : public C_AI_BaseNPC
{
public:
	C_BaseMastodon() {}

	DECLARE_CLASS( C_BaseMastodon, C_AI_BaseNPC );
	DECLARE_CLIENTCLASS();
 	DECLARE_DATADESC();
...
private:
	...
	C_BaseMastodon( const C_BaseMastodon & );
};
...
// Networking
//-----------------------------------------------------------------------------
IMPLEMENT_CLIENTCLASS_DT(C_BaseMastodon, DT_BaseMastodon, CBaseMastodon)
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void C_BaseMastodon::OnDataChanged( DataUpdateType_t type )
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void C_BaseMastodon::UpdateBleedingPerformance()
{
	// get my particles
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void C_BaseMastodon::ClientThink()
{
