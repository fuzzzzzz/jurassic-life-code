...
// Blur texture
//=============================================================================
static CTextureReference s_pBlurFB;
ITexture *GetBlurBuffer( void )
{
	if ( !s_pBlurFB )
	{
		s_pBlurFB.Init( materials->FindTexture( "_rt_Blur", TEXTURE_GROUP_RENDER_TARGET ) );
		Assert( !IsErrorTexture( s_pBlurFB ) );
		AddReleaseFunc();
	}
