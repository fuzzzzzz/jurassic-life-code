...
//JL
#include "jl/vgui_MenuBackground.h"
#include "jl/vgui_JLOptions.h"
#include "jl/IInventory.h"
#include "jl/ICase_Panel.h"
...
void VGui_CreateGlobalPanels( void )
{
	...
	inventory->Create( gameParent );
	casepanel->Create( gameParent );

	VPANEL GameUiDll = enginevgui->GetPanel( PANEL_GAMEUIDLL ); //PANEL_ROOT
	//casepanel->Create( GameUiDll );
	//inventory->Create( GameUiDll );
	GetJLOptionsPanel()->Create( GameUiDll );	
