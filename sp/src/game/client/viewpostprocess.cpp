...
//JL(TH): control bloom from vguiscreen transition
static ConVar mat_bloom_enable( "mat_bloom_enable", "1.0" );
...
//[JL - CTH - Dof
//PostProcessingPass DOF_FINAL[] =
//{
//	PPP_PROCESS_SRCTEXTURE( "dev/downsample", "_rt_FullFrameFB", "_rt_SmallFB0" ),
//	PPP_PROCESS_SRCTEXTURE( "shaders/post_dof", "_rt_FullFrameFB", NULL ),
//	PPP_END
//};
//JL]
...
static float GetBloomAmount( void )
{
	...
	//JL
	flBloomAmount *= mat_bloom_enable.GetFloat();
...
void DoEnginePostProcessing( int x, int y, int w, int h, bool bFlashlightIsOn, bool bPostVGui )
{
	...
	//JL(TH)
	//ApplyPostProcessingPasses(DOF_FINAL);
