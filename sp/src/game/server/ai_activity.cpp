...
//===========================
// Jurassic life Specific Activities
//===========================

	//SPAS12
	REGISTER_SHARED_ACTIVITY( ACT_RANGE_ATTACK_SPAS12 );
	REGISTER_SHARED_ACTIVITY( ACT_RELOAD_SPAS12 );
	REGISTER_SHARED_ACTIVITY( ACT_SPAS12_RELOAD_START );
	REGISTER_SHARED_ACTIVITY( ACT_SPAS12_RELOAD_FINISH );
	REGISTER_SHARED_ACTIVITY( ACT_SPAS12_PUMP );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_ANGRY_SPAS12 );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_SPAS12_RELAXED );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_SPAS12_STIMULATED );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_SPAS12_AGITATED );
	REGISTER_SHARED_ACTIVITY( ACT_SPAS12_STOCK_DOWN );
	REGISTER_SHARED_ACTIVITY( ACT_SPAS12_STOCK_UP );
	REGISTER_SHARED_ACTIVITY( ACT_SPAS12_STOCK_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_SPAS12_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_SPAS12_SD_PRIMARYATTACK );

	//Lindstradt Tranqualizer

	REGISTER_SHARED_ACTIVITY( ACT_RANGE_ATTACK_LINDS );
	REGISTER_SHARED_ACTIVITY( ACT_RELOAD_LINDS );
	REGISTER_SHARED_ACTIVITY( ACT_LINDS_RELOAD_START );
	REGISTER_SHARED_ACTIVITY( ACT_LINDS_RELOAD_FINISH );
	REGISTER_SHARED_ACTIVITY( ACT_LINDS_PUMP );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_ANGRY_LINDS );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_LINDS_RELAXED );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_LINDS_STIMULATED );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_LINDS_AGITATED );
