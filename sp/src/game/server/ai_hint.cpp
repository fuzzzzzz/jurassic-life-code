...
hinttypedescs_t g_pszHintDescriptions[] =
{
	...
	//JL HINTs
	{	HINT_RAPTOR_BURROW_POINT, "Velociraptor: Burrow Point"	},
	{	HINT_RAPTOR_DANGER_FLEE_POINT, "Velociraptor: Danger Flee Point"	},
	{	HINT_GALLIMIMUS_DANGER_FLEE_POINT, "Gallimimus: Danger Flee Point"	},
