...
#else
/* OLDER VALVE /HL2  HULLS DEFINITION
ai_hull_t  Human_Hull			(bits_HUMAN_HULL,			"HUMAN_HULL",			Vector(-13,-13,   0),	Vector(13, 13, 72),		Vector(-8,-8,   0),		Vector( 8,  8, 72) );
ai_hull_t  Small_Centered_Hull	(bits_SMALL_CENTERED_HULL,	"SMALL_CENTERED_HULL",	Vector(-20,-20, -20),	Vector(20, 20, 20),		Vector(-12,-12,-12),	Vector(12, 12, 12) );
...
// JL Custom Hulls definition

ai_hull_t  Human_Hull			(bits_HUMAN_HULL,			"HUMAN_HULL",			Vector(-13,-13,   0),	Vector(13, 13, 72),		Vector(-8,-8,   0),		Vector( 8,  8, 72) );
ai_hull_t  Small_Centered_Hull	(bits_SMALL_CENTERED_HULL,	"SMALL_CENTERED_HULL",	Vector(-6,-4, -2),		Vector(6, 4, 2),		Vector(-6,-4,-2),		Vector(6, 4, 2) );
ai_hull_t  Wide_Human_Hull		(bits_WIDE_HUMAN_HULL,		"WIDE_HUMAN_HULL",		Vector(-15,-15,   0),	Vector(15, 15, 72),		Vector(-10,-10, 0),		Vector(10, 10, 72) );
ai_hull_t  Tiny_Hull			(bits_TINY_HULL,			"TINY_HULL",			Vector(-6, -6,   0),	Vector(6, 6, 24),		Vector(-6,-6, 0),	    Vector(6, 6, 24) ); //Vector(-12,-12,   0),	Vector(12, 12, 24),		Vector(-12,-12, 0),	    Vector(12, 12, 24) );
ai_hull_t  Wide_Short_Hull		(bits_WIDE_SHORT_HULL,		"WIDE_SHORT_HULL",		Vector(-35,-35,   0),	Vector(35, 35, 72),		Vector(-20,-20, 0),	    Vector(20, 20, 72) );
ai_hull_t  Medium_Hull			(bits_MEDIUM_HULL,			"MEDIUM_HULL",			Vector(-54,-8,   0),	Vector(54, 8, 64),		Vector(-12,-8, 0),	    Vector(8, 8, 64) ); //Vector(-16,-16,   0),	Vector(16, 16, 64),		Vector(-8,-8, 0),	    Vector(8, 8, 64) );
ai_hull_t  Tiny_Centered_Hull	(bits_TINY_CENTERED_HULL,	"TINY_CENTERED_HULL",	Vector(-8,	-8,  -4),	Vector(8, 8,  4),		Vector(-8,-8, -4),		Vector( 8, 8, 4) );
ai_hull_t  Large_Hull			(bits_LARGE_HULL,			"LARGE_HULL",			Vector(-60,-40,   0),	Vector(40, 40, 100),	Vector(-60,-40, 0),		Vector(40, 40, 100) );
ai_hull_t  Large_Centered_Hull	(bits_LARGE_CENTERED_HULL,	"LARGE_CENTERED_HULL",	Vector(-30,-30, 0),		Vector(30, 30, 25),		Vector(-30,-30,0),		Vector(30, 30, 25) );
ai_hull_t  Medium_Tall_Hull		(bits_MEDIUM_TALL_HULL,		"MEDIUM_TALL_HULL",		Vector(-18,-18,   0),	Vector(18, 18, 100),	Vector(-12,-12, 0),	    Vector(12, 12, 100) );

ai_hull_t  Trex_Hull			(bits_TREX_HULL,			"TREX_HULL",			Vector(-38,-38, 0),		Vector(38, 38, 38),		Vector(-30,-30,0),		Vector(30, 30, 38) );
ai_hull_t  Vehicle_Hull			(bits_VEHICLE_HULL,			"VEHICLE_HULL",			Vector(-18,-18, 0),		Vector(18, 18, 100),	Vector(-12,-12, 0),	    Vector(12, 12, 100) );

//ai_hull_t	Piranha_Hull			(bits_PIRANHA_HULL,		"PIRANHA_HULL",			Vector(-4,-2, 2),		Vector(4, 2, 5),		Vector(-4,-2, 2),	    Vector(4, 2, 5) );
//ai_hull_t	Brycon_Hull				(bits_BRYCON_HULL,		"BRYCON_HULL",			Vector(-4,-2, 2),		Vector(4, 2, 5),		Vector(-4,-2, 2),	    Vector(4, 2, 5) );
//ai_hull_t	Crocodile_Hull			(bits_CROCODILE_HULL,	"CROCODILE_HULL",		Vector(-64,-16, 0),		Vector(32, 16, 32),		Vector(-64,-16, 0),	    Vector(32, 16, 32) );
//ai_hull_t	Compy_Hull				(bits_COMPY_HULL,		"COMPY_HULL",			Vector(-4,-4, 0),		Vector(4, 4, 12),		Vector(-4,-4,   0),		Vector( 4, 4, 12) );
//ai_hull_t	Tiny_Compy_Hull			(bits_TINY_COMPY_HULL,	"TINY_COMPY_HULL",		Vector(-12,-6, 0),		Vector(12, 6, 24),		Vector(-12,-6, 0),	    Vector(12, 6, 24) );
