...
//JL forklift
	void SetElevatorEnable(bool enable, IPhysicsObject *physobj=NULL, IPhysicsObject *physobjbase=NULL);
	bool GetElevatorEnable();
	void UpdateElevator();
	void CallUpdateElevator();
...
protected: //JL
	...
	//JL(TH) : Forklift elevator
	bool				m_bElevator;
	IPhysicsObject		*m_pElevator;
	IPhysicsObject		*m_pElevatorBase;
	//CPhysicsProp		*m_pElevatorProp;
	Vector				m_ElevatorPosition;
	QAngle				m_ElevatorRotation;
	IPhysicsConstraint	*m_pElevatorConstraint;
	Vector				m_ElevatorHeight[2];
	bool				m_bElevatorUpdate;
