...
class CMattsPipe : public CWeaponMachete //Crowbar
{
	DECLARE_CLASS( CMattsPipe, CWeaponMachete ); //Crowbar );

	const char *GetWorldModel() const	{ return "models/jl/weapons/w_machete.mdl"; }
