...
LINK_ENTITY_TO_CLASS( npc_quetzal, CNPC_Quetzal );
...
void CNPC_Crow::Precache( void )
{
	...
	//JL
	//PrecacheModel( "models/bird.mdl" );
	PrecacheModel( "models/jl/animals/quetzal.mdl" );
	//PrecacheModel( "models/jl/animals/toucan.mdl" );
	//Toucan
	//PrecacheScriptSound( "NPC_Toucan.Pain" );
	//PrecacheScriptSound( "NPC_Toucan.Idle" );

	//Quetzal
	PrecacheScriptSound( "NPC_Quetzal.Pain" );
	PrecacheScriptSound( "NPC_Quetzal.Idle" );
	PrecacheScriptSound( "NPC_Quetzal.Alert" );
	PrecacheScriptSound( "NPC_Quetzal.Die" );
}
