...
#include "npc_velociraptor.h"
#include "npc_mastodon.h"
#include "decals.h"
...
ConVar	g_debug_mastodon( "g_debug_mastodon", "0" );

ConVar	sk_trex_dmg_charge( "sk_trex_dmg_charge", "0" );
ConVar	sk_trex_dmg_shove( "sk_trex_dmg_shove", "0" );

ConVar	sk_triceratops_dmg_charge( "sk_triceratops_dmg_charge", "0" );
ConVar	sk_triceratops_dmg_shove( "sk_triceratops_dmg_shove", "0" );

//#if HL2_EPISODIC
//// When enabled, add code to have the antlion bleed profusely as it is badly injured.
//#define TREX_BLOOD_EFFECTS 2
//ConVar	g_trex_hemorrhage( "g_trex_hemorrhage", "1", FCVAR_NONE, "If 1, guard will emit a bleeding particle effect when wounded." );
//#endif

// Spawnflags 
#define	SF_MASTODON_SERVERSIDE_RAGDOLL	( 1 << 16 )
#define SF_MASTODON_INSIDE_FOOTSTEPS	( 1 << 17 )

#define	ENVELOPE_CONTROLLER		(CSoundEnvelopeController::GetController())
#define	TREX_MODEL		"models/jl/dinosaurs/tyrannosaurus.mdl"
#define	TRICERATOPS_MODEL		"models/jl/dinosaurs/triceratops.mdl"
...
#define MASTODON_MAX_OBJECTS				128
#define	MASTODON_MIN_OBJECT_MASS			8
#define	MASTODON_MAX_OBJECT_MASS			1500
//#define	MASTODON_FARTHEST_PHYSICS_OBJECT	350
#define MASTODON_OBJECTFINDING_FOV			DOT_45DEGREE // 1/sqrt(2)

//Melee definitions
#define	MASTODON_MELEE1_RANGE		256.0f //156.0f
#define	MASTODON_MELEE1_CONE		0.7f

// Antlion summoning
#define MASTODON_SUMMON_COUNT		3

// Sight
#define	TREX_FOV_NORMAL			-0.4f
#define	TRICERATOPS_FOV_NORMAL			-0.4f

// cavern guard's poisoning behavior
#if HL2_EPISODIC
#define MASTODON_POISON_TO			12 // we only poison Gordon down to twelve to give him a chance to regen up to 20 by the next charge
#endif

#define	MASTODON_CHARGE_MIN			512 //256
#define	MASTODON_CHARGE_MAX			2048

ConVar	sk_trex_health( "sk_trex_health", "0" );
ConVar	sk_triceratops_health( "sk_triceratops_health", "0" );

int	g_interactionMastodonFoundPhysicsObject = 0;	// We're moving to a physics object to shove it, don't all choose the same object
int	g_interactionMastodonShovedPhysicsObject = 0;	// We've punted an object, it is now clear to be chosen by others
...
enum
{
	SCHED_MASTODON_CHARGE = LAST_SHARED_SCHEDULE,
	SCHED_MASTODON_CHARGE_CRASH,
	SCHED_MASTODON_CHARGE_CANCEL,
	SCHED_MASTODON_PHYSICS_ATTACK,
	SCHED_MASTODON_PHYSICS_DAMAGE_HEAVY,
	SCHED_MASTODON_UNBURROW,
	SCHED_MASTODON_CHARGE_TARGET,
	SCHED_MASTODON_FIND_CHARGE_POSITION,
	SCHED_MASTODON_MELEE_ATTACK1,
	SCHED_MASTODON_SUMMON,
	SCHED_MASTODON_PATROL_RUN,
	SCHED_MASTODON_ROAR,
	SCHED_MASTODON_CHASE_ENEMY_TOLERANCE,
	SCHED_FORCE_MASTODON_PHYSICS_ATTACK,
	SCHED_MASTODON_CANT_ATTACK,
	SCHED_MASTODON_TAKE_COVER_FROM_ENEMY,
	SCHED_MASTODON_CHASE_ENEMY
};
...
enum
{
	TASK_MASTODON_CHARGE = LAST_SHARED_TASK,
	TASK_MASTODON_GET_PATH_TO_PHYSOBJECT,
	TASK_MASTODON_SHOVE_PHYSOBJECT,
	TASK_MASTODON_SUMMON,
	TASK_MASTODON_SET_FLINCH_ACTIVITY,
	TASK_MASTODON_GET_PATH_TO_CHARGE_POSITION,
	TASK_MASTODON_GET_PATH_TO_NEAREST_NODE,
	TASK_MASTODON_GET_CHASE_PATH_ENEMY_TOLERANCE,
	TASK_MASTODON_OPPORTUNITY_THROW,
	TASK_MASTODON_FIND_PHYSOBJECT,
};
...
enum
{
	COND_MASTODON_PHYSICS_TARGET = LAST_SHARED_CONDITION,
	COND_MASTODON_PHYSICS_TARGET_INVALID,
	COND_MASTODON_HAS_CHARGE_TARGET,
	COND_MASTODON_CAN_SUMMON,
	COND_MASTODON_CAN_CHARGE
};

enum
{	
	SQUAD_SLOT_MASTODON_CHARGE = LAST_SHARED_SQUADSLOT,
};
...
Activity ACT_MASTODON_SEARCH;
Activity ACT_MASTODON_PEEK_FLINCH;
Activity ACT_MASTODON_PEEK_ENTER;
Activity ACT_MASTODON_PEEK_EXIT;
Activity ACT_MASTODON_PEEK1;
Activity ACT_MASTODON_BARK;
Activity ACT_MASTODON_PEEK_SIGHTED;
Activity ACT_MASTODON_SHOVE_PHYSOBJECT;
Activity ACT_MASTODON_FLINCH_LIGHT;
Activity ACT_MASTODON_UNBURROW;
Activity ACT_MASTODON_ROAR;
Activity ACT_MASTODON_RUN_HURT;

// Flinches
Activity ACT_MASTODON_PHYSHIT_FR;
Activity ACT_MASTODON_PHYSHIT_FL;
Activity ACT_MASTODON_PHYSHIT_RR;
Activity ACT_MASTODON_PHYSHIT_RL;

// Charge
Activity ACT_MASTODON_CHARGE_START;
Activity ACT_MASTODON_CHARGE_CANCEL;
Activity ACT_MASTODON_CHARGE_RUN;
Activity ACT_MASTODON_CHARGE_CRASH;
Activity ACT_MASTODON_CHARGE_STOP;
Activity ACT_MASTODON_CHARGE_HIT;
Activity ACT_MASTODON_CHARGE_ANTICIPATION;

// Anim events
int AE_MASTODON_CHARGE_HIT;
int AE_MASTODON_SHOVE_PHYSOBJECT;
int AE_MASTODON_SHOVE;
int AE_MASTODON_FOOTSTEP_LIGHT;
int AE_MASTODON_FOOTSTEP_HEAVY;
int AE_MASTODON_CHARGE_EARLYOUT;
int AE_MASTODON_VOICE_GROWL;
int AE_MASTODON_VOICE_BARK;
int AE_MASTODON_VOICE_PAIN;
int AE_MASTODON_VOICE_SQUEEZE;
int AE_MASTODON_VOICE_SCRATCH;
int AE_MASTODON_VOICE_GRUNT;
int AE_MASTODON_VOICE_ROAR;
int AE_MASTODON_BURROW_OUT;


//==================================================
// CNPC_TRex::m_DataDesc
//==================================================

BEGIN_DATADESC( CBaseMastodon )
	...
	DEFINE_FIELD( m_iNumLiveRaptors,	FIELD_INTEGER ),
...
envelopePoint_t envMastodonFastGrowl[] =
{
	{	1.0f, 1.0f,
		0.2f, 0.4f,
	},
...
//Bark 1 (Growl High)
envelopePoint_t envMastodonBark1[] =
{
	{	1.0f, 1.0f,
		0.1f, 0.2f,
	},
...
//Bark 2 (Confused)
envelopePoint_t envMastodonBark2[] =
{
	{	1.0f, 1.0f,
		0.1f, 0.2f,
	},
...
//Pain
envelopePoint_t envMastodonPain1[] =
{
	{	1.0f, 1.0f,
		0.1f, 0.2f,
	},
...
//Squeeze (High Growl)
envelopePoint_t envMastodonSqueeze[] =
{
	{	1.0f, 1.0f,
		0.1f, 0.2f,
	},
...
//Scratch (Low Growl)
envelopePoint_t envMastodonScratch[] =
{
	{	1.0f, 1.0f,
		0.4f, 0.6f,
	},
...
//Grunt
envelopePoint_t envMastodonGrunt[] =
{
	{	0.6f, 1.0f,
		0.1f, 0.2f,
	},
...
envelopePoint_t envMastodonGrunt2[] =
{
	{	0.2f, 0.4f,
		0.1f, 0.2f,
	},
...
//==============================================================================================
// MASTODON PHYSICS DAMAGE TABLE
//==============================================================================================
static impactentry_t mastodonLinearTable[] =
{
	{ 100*100,	10 },
	{ 250*250,	25 },
	{ 350*350,	50 },
...
static impactentry_t mastodonAngularTable[] =
{
	{  50* 50, 10 },
	{ 100*100, 25 },
	{ 150*150, 50 },
...
impactdamagetable_t gMastodonImpactDamageTable =
{
	mastodonLinearTable,
	mastodonAngularTable,
	
	ARRAYSIZE(mastodonLinearTable),
	ARRAYSIZE(mastodonAngularTable),
...
//-----------------------------------------------------------------------------
const impactdamagetable_t &CBaseMastodon::GetPhysicsImpactDamageTable( void )
{
	return gMastodonImpactDamageTable;
}
...
CBaseMastodon::CBaseMastodon( void )
{
...
LINK_ENTITY_TO_CLASS( npc_mastodon, CBaseMastodon );

IMPLEMENT_SERVERCLASS_ST(CBaseMastodon, DT_BaseMastodon)
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseMastodon::UpdateOnRemove( void )
{
	DestroyGlows();
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseMastodon::Precache( void )
{
	/*
	PrecacheModel( TREX_MODEL );

	PrecacheScriptSound( "NPC_AntlionGuard.Shove" );
	PrecacheScriptSound( "NPC_AntlionGuard.HitHard" );

	if ( HasSpawnFlags(SF_TREX_INSIDE_FOOTSTEPS) )
	{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseMastodon::DestroyGlows( void )
{
	if ( m_hCaveGlow[0] )
	{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseMastodon::CreateGlow( CSprite **pSprite, const char *pAttachName )
{
	if ( pSprite == NULL )
		return;
...
void CBaseMastodon::Spawn( void )
{
	...
	//m_iHealth = sk_trex_health.GetFloat();
	//m_iMaxHealth = m_iHealth;
	//m_flFieldOfView	= MASTODON_FOV_NORMAL;
	...
	CapabilitiesClear();
	CapabilitiesAdd( bits_CAP_MOVE_GROUND | bits_CAP_INNATE_MELEE_ATTACK1 | bits_CAP_TURN_HEAD  );
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseMastodon::Activate( void )
{
	BaseClass::Activate();
	...
	while ( ( pObject = gEntList.FindEntityInSphere( pObject, WorldSpaceCenter(), 2500 ) ) != NULL )
	{
		...
		if( ( pPhysObj == NULL ) || ( pPhysObj->GetMass() > MASTODON_MAX_OBJECT_MASS ) || ( pPhysObj->GetMass() < MASTODON_MIN_OBJECT_MASS ) )
			continue;

		// Tell the AI sensing list that we want to consider this
		g_AI_SensedObjectsManager.AddEntity( pObject );

		if ( g_debug_mastodon.GetInt() == 5 )
		{
			Msg("TRex/Triceratops: Added prop with model '%s' to sense list.\n", STRING(pObject->GetModelName()) );
...
//-----------------------------------------------------------------------------
bool CBaseMastodon::CanSummon( bool bIgnoreTime )
{
	if ( !m_bBarkEnabled )
		return false;
	...
	if ( m_iNumLiveRaptors >= max(1, MASTODON_SUMMON_COUNT-1) )
		return false;
...
//-----------------------------------------------------------------------------
int CBaseMastodon::SelectUnreachableSchedule( void )
{
	// If we're in the cavern setting, we opt out of this
	if ( m_bInCavern )
		return SCHED_MASTODON_CHASE_ENEMY_TOLERANCE;
	// Summon antlions if we can
	if ( HasCondition( COND_MASTODON_CAN_SUMMON ) )
		return SCHED_MASTODON_SUMMON;
	...
	if ( pTarget )
	{
		...
		SetCondition( COND_MASTODON_PHYSICS_TARGET );
		...
		if ( GetSquad() != NULL )
		{
			GetSquad()->BroadcastInteraction( g_interactionMastodonFoundPhysicsObject, (void *)((CBaseEntity *)m_hPhysicsTarget), this );
		}

		return SCHED_MASTODON_PHYSICS_ATTACK;
	}
	...
	if ( HasCondition( COND_SEE_ENEMY ) )
	{
		...
		if ( GetEnemy() && HasCondition( COND_HEAVY_DAMAGE ) )
		{
			...
			return SCHED_MASTODON_TAKE_COVER_FROM_ENEMY;
		}
	}
	...
	return SCHED_MASTODON_CANT_ATTACK;
}

//-----------------------------------------------------------------------------
// Purpose: 
//-----------------------------------------------------------------------------
int CBaseMastodon::SelectCombatSchedule( void )
{
	ClearHintGroup();
	...
	*/
	...
	if ( HasCondition(COND_MASTODON_CAN_SUMMON) )
	{
		...
		if ( HasCondition( COND_MASTODON_CAN_CHARGE ) && m_iNumLiveRaptors )
			return SCHED_MASTODON_CHARGE;
	...
	//Physics target
	if ( HasCondition( COND_MASTODON_PHYSICS_TARGET ) && !m_bInCavern )
		return SCHED_MASTODON_PHYSICS_ATTACK;
	...
	// Charging
	if ( HasCondition( COND_MASTODON_CAN_CHARGE ) )
	{
		// Don't let other squad members charge while we're doing it
		OccupyStrategySlot( SQUAD_SLOT_MASTODON_CHARGE );
		return SCHED_MASTODON_CHARGE;
	}
...
//-----------------------------------------------------------------------------
bool CBaseMastodon::ShouldCharge( const Vector &startPos, const Vector &endPos, bool useTime, bool bCheckForCancel )
{
	...
	if ( IsStrategySlotRangeOccupied( SQUAD_SLOT_MASTODON_CHARGE, SQUAD_SLOT_MASTODON_CHARGE ) )
		return false;
	...
	if ( !bCheckForCancel )
	{
		...
		if ( ( distance < MASTODON_CHARGE_MIN ) || ( distance > MASTODON_CHARGE_MAX ) )
			return false;
	}
	...
	if ( IsMoveBlocked( moveTrace ) )
	{
		...
		if ( UTIL_DistApprox( WorldSpaceCenter(), moveTrace.vEndPosition ) < MASTODON_CHARGE_MIN )
			return false;
...
// Purpose: 
//-----------------------------------------------------------------------------
int CBaseMastodon::SelectSchedule( void )
{
	...
	if ( !m_bInCavern && HasCondition( COND_HEAVY_DAMAGE ) && m_flNextHeavyFlinchTime < gpGlobals->curtime )
	{
		...
		return SCHED_MASTODON_PHYSICS_DAMAGE_HEAVY;
	}
	...
	if ( m_bPreferPhysicsAttack )
	{
		...
		if ( HasCondition( COND_MASTODON_PHYSICS_TARGET ) )
			return SCHED_MASTODON_PHYSICS_ATTACK;
	}
	...
	{
		ClearCondition( COND_MASTODON_HAS_CHARGE_TARGET );
		ClearHintGroup();
		...
		else
		{
			...
			if ( ShouldCharge( GetAbsOrigin(), GetEnemy()->GetAbsOrigin(), false, false ) == false )
				return SCHED_MASTODON_FIND_CHARGE_POSITION;

			return SCHED_MASTODON_CHARGE_TARGET;
		}
	}
...
// Purpose: 
//-----------------------------------------------------------------------------
int CBaseMastodon::MeleeAttack1Conditions( float flDot, float flDist )
{
	...
	if ( IsCurSchedule( SCHED_MASTODON_CHARGE ) )
		return 0;
	...
	if ( hl2_episodic.GetBool() && m_bInCavern )
	{
		...
		if ( ( GetAbsOrigin() - vecPredPos ).Length() > MASTODON_MELEE1_RANGE )
			return COND_TOO_FAR_TO_ATTACK;
	}
	else
	{
		// Must be close enough
		if ( flDist > MASTODON_MELEE1_RANGE )
			return COND_TOO_FAR_TO_ATTACK;
	}

	// Must be within a viable cone
	if ( flDot < MASTODON_MELEE1_CONE )
...
// Purpose: 
//-----------------------------------------------------------------------------
float CBaseMastodon::MaxYawSpeed( void )
{
	Activity eActivity = GetActivity();

	// Stay still
	if (( eActivity == ACT_MASTODON_SEARCH ) || 
		( eActivity == ACT_MASTODON_PEEK_ENTER ) || 
		( eActivity == ACT_MASTODON_PEEK_EXIT ) || 
		( eActivity == ACT_MASTODON_PEEK1 ) || 
		( eActivity == ACT_MASTODON_BARK ) || 
		( eActivity == ACT_MASTODON_PEEK_SIGHTED ) || 
	...
	if ( eActivity == ACT_MASTODON_CHARGE_START )
		return 4.0f;

	if ( hl2_episodic.GetBool() && m_bInCavern )
	{
		// Allow a better turning rate when moving quickly but not charging the player
		if ( ( eActivity == ACT_MASTODON_CHARGE_RUN ) && IsCurSchedule( SCHED_MASTODON_CHARGE ) == false )
			return 18.0f;
	}

	// Turn more slowly as we close in on our target
	if ( eActivity == ACT_MASTODON_CHARGE_RUN )
	{
		if ( pEnemy == NULL )
			return 2.0f;
	...
	if ( eActivity == ACT_MASTODON_CHARGE_STOP )
		return 12.0f;
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseMastodon::OverrideMove( float flInterval )
{
...
void CBaseMastodon::Shove( void )
{
	...
	float damage = ( pTarget->IsPlayer() ) ? sk_trex_dmg_shove.GetFloat() : 250;
	...
	if ( flDistSqr < (MASTODON_MELEE1_RANGE*MASTODON_MELEE1_RANGE) && flDot >= MASTODON_MELEE1_CONE )
	{
		vecEnd = pTarget->WorldSpaceCenter();
	}
	else
	{
		vecEnd = WorldSpaceCenter() + ( BodyDirection3D() * MASTODON_MELEE1_RANGE );
	}
	...
	if ( pHurt )
	{
		...
		if ( pHurt->IsPlayer() )
		{
			...
			if ( m_bInCavern && pHurt->IsPlayer() && pHurt->IsAlive() && pHurt->m_iHealth > MASTODON_POISON_TO)
			{
				// That didn't finish them. Take them down to one point with poison damage. It'll heal.
				pHurt->TakeDamage( CTakeDamageInfo( this, this, pHurt->m_iHealth - MASTODON_POISON_TO, DMG_POISON ) );
			}
#endif
...
public:
	...
	CTraceFilterCharge( const IHandleEntity *passentity, int collisionGroup, CBaseMastodon *pAttacker )
	...
	virtual bool ShouldHitEntity( IHandleEntity *pHandleEntity, int contentsMask )
	{
		...
		if ( pEntity )
		{
			...
			float	flDamage = ( pEntity->IsPlayer() ) ? sk_trex_dmg_shove.GetFloat() : 250;;
...
//-----------------------------------------------------------------------------
void CBaseMastodon::Footstep( bool bHeavy )
{
...
//			*pOut - 
//-----------------------------------------------------------------------------
void CBaseMastodon::GetPhysicsShoveDir( CBaseEntity *pObject, float flMass, Vector *pOut )
{
...
// Input  : *pEvent - 
//-----------------------------------------------------------------------------
void CBaseMastodon::HandleAnimEvent( animevent_t *pEvent )
{
	if ( pEvent->event == AE_MASTODON_CHARGE_EARLYOUT )
	{
		...
		{
			SetSchedule( SCHED_TREX_CHARGE_CANCEL );
		}
		*/
	...
	if ( pEvent->event == AE_MASTODON_SHOVE_PHYSOBJECT )
	{
		if ( m_hPhysicsTarget == NULL )
		{
		...
		ClearCondition( COND_MASTODON_PHYSICS_TARGET );
		ClearCondition( COND_MASTODON_PHYSICS_TARGET_INVALID );
		...
		if ( GetSquad() != NULL )
		{
			GetSquad()->BroadcastInteraction( g_interactionMastodonShovedPhysicsObject, (void *)((CBaseEntity *)m_hPhysicsTarget), this );
		}
	...
	if ( pEvent->event == AE_MASTODON_CHARGE_HIT )
	{
	...
	if ( pEvent->event == AE_MASTODON_SHOVE )
	{
	...
	if ( pEvent->event == AE_MASTODON_FOOTSTEP_LIGHT )
	{
		if ( HasSpawnFlags(SF_MASTODON_INSIDE_FOOTSTEPS) )
		{
#if HL2_EPISODIC
			Footstep( false );
#else 
	...
	if ( pEvent->event == AE_MASTODON_FOOTSTEP_HEAVY )
	{
		if ( HasSpawnFlags(SF_MASTODON_INSIDE_FOOTSTEPS) )
		{
#if HL2_EPISODIC
	...
	if ( pEvent->event == AE_MASTODON_VOICE_GROWL )
	{
		StartSounds();
		...
		{
			duration = ENVELOPE_CONTROLLER.SoundPlayEnvelope( m_pGrowlHighSound, SOUNDCTRL_CHANGE_VOLUME, envMastodonFastGrowl, ARRAYSIZE(envMastodonFastGrowl) );
		}
		else
		{
			duration = 1.0f;
	...
	if ( pEvent->event == AE_MASTODON_VOICE_BARK )
	{
		StartSounds();

		float duration = ENVELOPE_CONTROLLER.SoundPlayEnvelope( m_pGrowlHighSound, SOUNDCTRL_CHANGE_VOLUME, envMastodonBark1, ARRAYSIZE(envMastodonBark1) );
		ENVELOPE_CONTROLLER.SoundPlayEnvelope( m_pConfusedSound, SOUNDCTRL_CHANGE_VOLUME, envMastodonBark2, ARRAYSIZE(envMastodonBark2) );
	...
	if ( pEvent->event == AE_MASTODON_VOICE_ROAR )
	{
		StartSounds();

		float duration = ENVELOPE_CONTROLLER.SoundPlayEnvelope( m_pGrowlHighSound, SOUNDCTRL_CHANGE_VOLUME, envMastodonFastGrowl, ARRAYSIZE(envMastodonFastGrowl) );
	...
	if ( pEvent->event == AE_MASTODON_VOICE_PAIN )
	{
		StartSounds();

		float duration = ENVELOPE_CONTROLLER.SoundPlayEnvelope( m_pConfusedSound, SOUNDCTRL_CHANGE_VOLUME, envMastodonPain1, ARRAYSIZE(envMastodonPain1) );
		ENVELOPE_CONTROLLER.SoundPlayEnvelope( m_pGrowlHighSound, SOUNDCTRL_CHANGE_VOLUME, envMastodonBark2, ARRAYSIZE(envMastodonBark2) );
	...
	if ( pEvent->event == AE_MASTODON_VOICE_SQUEEZE )
	{	
		StartSounds();

		float duration = ENVELOPE_CONTROLLER.SoundPlayEnvelope( m_pGrowlHighSound, SOUNDCTRL_CHANGE_VOLUME, envMastodonSqueeze, ARRAYSIZE(envMastodonSqueeze) );
	...
	if ( pEvent->event == AE_MASTODON_VOICE_SCRATCH )
	{	
		StartSounds();
	...
	if ( pEvent->event == AE_MASTODON_VOICE_GRUNT )
	{	
		StartSounds();

		float duration = ENVELOPE_CONTROLLER.SoundPlayEnvelope( m_pConfusedSound, SOUNDCTRL_CHANGE_VOLUME, envMastodonGrunt, ARRAYSIZE(envMastodonGrunt) );
		ENVELOPE_CONTROLLER.SoundPlayEnvelope( m_pGrowlHighSound, SOUNDCTRL_CHANGE_VOLUME, envMastodonGrunt2, ARRAYSIZE(envMastodonGrunt2) );
	...
	if ( pEvent->event == AE_MASTODON_BURROW_OUT )
	{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseMastodon::SetHeavyDamageAnim( const Vector &vecSource )
{
	if ( !m_bInCavern )
	{
		...
		if ( damageDot > 0.0f )
		{
			...
			{
				m_nFlinchActivity = ACT_MASTODON_PHYSHIT_FR;
			}
			else
			{
				m_nFlinchActivity = ACT_MASTODON_PHYSHIT_FL;
			}
		}
		else
		{
			...
			if ( damageRightDot < 0.0f )
			{
				m_nFlinchActivity = ACT_MASTODON_PHYSHIT_RR;
			}
			else
			{
				m_nFlinchActivity = ACT_MASTODON_PHYSHIT_RL;
			}
		}
	}
}
...
// Input  : &info - 
//-----------------------------------------------------------------------------
int CBaseMastodon::OnTakeDamage_Alive( const CTakeDamageInfo &info )
{
	CTakeDamageInfo dInfo = info;

	// Don't take damage from another antlion guard!
	if ( dInfo.GetAttacker() && dInfo.GetAttacker() != this && FClassnameIs( dInfo.GetAttacker(), "npc_tyrannosaurus" ) )
		return 0;
...
//			bitsDamageType - 
//-----------------------------------------------------------------------------
void CBaseMastodon::TraceAttack( const CTakeDamageInfo &info, const Vector &vecDir, trace_t *ptr, CDmgAccumulator *pAccumulator )
{
...
// Input  : *pTask - 
//-----------------------------------------------------------------------------
void CBaseMastodon::StartTask( const Task_t *pTask )
{
	switch ( pTask->iTask )
	{
	case TASK_MASTODON_SET_FLINCH_ACTIVITY:
		SetIdealActivity( (Activity) m_nFlinchActivity );
		break;

	case TASK_MASTODON_SUMMON:
		SummonAntlions();
		m_OnSummon.FireOutput( this, this, 0 );
		TaskComplete();
		break;

	case TASK_MASTODON_SHOVE_PHYSOBJECT:
		{
			...
			SetActivity( ACT_MASTODON_SHOVE_PHYSOBJECT );
		}
		break;

	case TASK_MASTODON_FIND_PHYSOBJECT:
		{
	...
	case TASK_MASTODON_GET_PATH_TO_PHYSOBJECT:
		{
			if ( ( m_hPhysicsTarget == NULL ) || ( GetEnemy() == NULL ) )
			{
	...
	case TASK_MASTODON_GET_PATH_TO_NEAREST_NODE:
		{
			if ( !GetEnemy() )
			{
	...
	case TASK_MASTODON_GET_CHASE_PATH_ENEMY_TOLERANCE:
		{
	...
	case TASK_MASTODON_OPPORTUNITY_THROW:
		{
			// If we've got some live antlions, look for a physics object to throw
			if ( m_iNumLiveRaptors >= 2 && RandomFloat(0,1) > 0.5 )
			{
				m_FailedPhysicsTargets.RemoveAll();
				UpdatePhysicsTarget( false, m_bPreferPhysicsAttack ? (100*12) : MASTODON_FARTHEST_PHYSICS_OBJECT  );
				if ( HasCondition( COND_MASTODON_PHYSICS_TARGET ) && !m_bInCavern )
				{
					SetSchedule( SCHED_MASTODON_PHYSICS_ATTACK );
				}
			}
...
//-----------------------------------------------------------------------------
void ApplyMastodonChargeDamage( CBaseEntity *pMastodon, CBaseEntity *pTarget, float flDamage )
{
	Vector attackDir = ( pTarget->WorldSpaceCenter() - pMastodon->WorldSpaceCenter() );
	VectorNormalize( attackDir );
	...
	// Deal the damage
	CTakeDamageInfo	info( pMastodon, pMastodon, vecForce, offset, flDamage, DMG_CLUB );
	pTarget->TakeDamage( info );

#if HL2_EPISODIC
	// If I am a cavern guard attacking the player, and he still lives, then poison him too.
	Assert( dynamic_cast<CBaseMastodon *>(pMastodon) );

	if ( static_cast<CBaseMastodon *>(pMastodon)->IsInCavern() && pTarget->IsPlayer() && pTarget->IsAlive() && pTarget->m_iHealth > MASTODON_POISON_TO)
	{
		// That didn't finish them. Take them down to one point with poison damage. It'll heal.
		pTarget->TakeDamage( CTakeDamageInfo( pMastodon, pMastodon, pTarget->m_iHealth - MASTODON_POISON_TO, DMG_POISON ) );
	}
#endif
	...
	virtual bool ShouldHitEntity( IHandleEntity *pHandleEntity, int contentsMask )
	{
		...
		if ( pEntity )
		{
			...
			if ( pEntity->Classify() == CLASS_ANTLION )
			{
				...
				ApplyMastodonChargeDamage( pGuard, pEntity, pEntity->GetHealth() );
				return false;
			}
		}
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseMastodon::EnemyIsRightInFrontOfMe( CBaseEntity **pEntity )
{
	if ( !GetEnemy() )
		return false;
...
//-----------------------------------------------------------------------------
void CBaseMastodon::ChargeLookAhead( void )
{
	trace_t	tr;
	Vector vecForward;
	...
	if ( tr.fraction != 1.0 )
	{
		...
		AddGesture( ACT_MASTODON_CHARGE_ANTICIPATION );
	}
}
...
//-----------------------------------------------------------------------------
bool CBaseMastodon::HandleChargeImpact( Vector vecImpact, CBaseEntity *pEntity )
{
	...
	if ( IRelationType( pEntity ) == D_HT && ( GetNextAttack() < gpGlobals->curtime ) )
	{
		...
		if ( !IsPlayingGesture( ACT_MASTODON_CHARGE_HIT ) )
		{
			RestartGesture( ACT_MASTODON_CHARGE_HIT );
		}
		...
		SetActivity( ACT_MASTODON_CHARGE_STOP );
...
// Output : float
//-----------------------------------------------------------------------------
float CBaseMastodon::ChargeSteer( void )
{
	trace_t	tr;
...
// Input  : *pTask - 
//-----------------------------------------------------------------------------
void CBaseMastodon::RunTask( const Task_t *pTask )
{
	switch (pTask->iTask)
	{
	case TASK_MASTODON_SET_FLINCH_ACTIVITY:
	...
	case TASK_MASTODON_CHARGE:
		{
			...
			if ( eActivity == ACT_MASTODON_CHARGE_STOP || eActivity == ACT_MASTODON_CHARGE_CRASH ) 
			{
				if ( IsActivityFinished() )
				{
					TaskComplete();
			...
			if ( ( eActivity == ACT_MASTODON_CHARGE_START ) && ( IsActivityFinished() ) )
			{
				SetActivity( ACT_MASTODON_CHARGE_RUN );
			}

			// See if we're still running
			if ( eActivity == ACT_MASTODON_CHARGE_RUN || eActivity == ACT_MASTODON_CHARGE_START ) 
			{
			...
			if ( AutoMovement( GetEnemy(), &moveTrace ) == false )
			{
				...
				if ( HandleChargeImpact( moveTrace.vEndPosition, moveTrace.pObstruction ) )
				{
					...
					if ( eActivity != ACT_MASTODON_CHARGE_STOP )
					{
						...
						{
							SetActivity( ACT_MASTODON_CHARGE_CRASH );
						}
					}
				}
				else if ( moveTrace.pObstruction )
				{
					...
					{
						if ( FClassnameIs( moveTrace.pObstruction, "npc_tyrannosaurus" ) )
						{
							// Crash unless we're trying to stop already
							if ( eActivity != ACT_MASTODON_CHARGE_STOP )
							{
						...
						{
							ApplyMastodonChargeDamage( this, moveTrace.pObstruction, moveTrace.pObstruction->GetHealth() );
						}
					}
				}
			}
...
//-----------------------------------------------------------------------------
void CBaseMastodon::SummonAntlions( void )
{
	...
	int iSpawnPoint = 0;
	for ( int i = 0; (m_iNumLiveRaptors < MASTODON_SUMMON_COUNT) && (iSpawnPoint < ARRAYSIZE(sAntlionSpawnPositions)); i++ )
	{
		...
		CAI_BaseNPC	*pent = (CAI_BaseNPC*)CreateEntityByName( "npc_velociraptor" );
		if ( !pent )
			break;

		CNPC_Raptor *pRaptor = assert_cast<CNPC_Raptor*>(pent);
		...
		pRaptor->SetAbsAngles( vecAngles );

		pRaptor->AddSpawnFlags( SF_NPC_FALL_TO_GROUND );
		pRaptor->AddSpawnFlags( SF_NPC_FADE_CORPSE );

		// Make the antlion fire my input when he dies
		pRaptor->KeyValue( "OnDeath", UTIL_VarArgs("%s,SummonedAntlionDied,,0,-1", STRING(GetEntityName())) );

		// Start the antlion burrowed, and tell him to come up
		pRaptor->m_bStartBurrowed = true;
		DispatchSpawn( pRaptor );
		pRaptor->Activate();
		g_EventQueue.AddEvent( pRaptor, "Unburrow", RandomFloat(0.1, 1.0), this, this );

		// Add it to our squad
		if ( GetSquad() != NULL )
		{
			GetSquad()->AddToSquad( pRaptor );
		}

		// Set the antlion's enemy to our enemy
		if ( GetEnemy() )
		{
			pRaptor->SetEnemy( GetEnemy() );
			pRaptor->SetState( NPC_STATE_COMBAT );
			pRaptor->UpdateEnemyMemory( GetEnemy(), GetEnemy()->GetAbsOrigin() );
		}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseMastodon::FoundEnemy( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseMastodon::LostEnemy( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseMastodon::InputSetShoveTarget( inputdata_t &inputdata )
{
	if ( IsAlive() == false )
		return;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseMastodon::InputSetChargeTarget( inputdata_t &inputdata )
{
	if ( !IsAlive() )
		return;
	...
	SetCondition( COND_MASTODON_HAS_CHARGE_TARGET );
...
// Input  : &inputdata - 
//-----------------------------------------------------------------------------
void CBaseMastodon::InputClearChargeTarget( inputdata_t &inputdata )
{
	m_hChargeTarget = NULL;
}
...
// Output : Activity
//-----------------------------------------------------------------------------
Activity CBaseMastodon::NPC_TranslateActivity( Activity baseAct )
{
	//See which run to use
	if ( ( baseAct == ACT_RUN ) && IsCurSchedule( SCHED_MASTODON_CHARGE ) )
		return (Activity) ACT_MASTODON_CHARGE_RUN;
	...
	if ( ( baseAct == ACT_RUN ) && ( m_iHealth <= (m_iMaxHealth/4) ) )
		return (Activity) ACT_MASTODON_RUN_HURT;
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseMastodon::ShouldWatchEnemy( void )
{
	Activity nActivity = GetActivity();

	if ( ( nActivity == ACT_MASTODON_SEARCH ) || 
		 ( nActivity == ACT_MASTODON_PEEK_ENTER ) || 
		 ( nActivity == ACT_MASTODON_PEEK_EXIT ) || 
		 ( nActivity == ACT_MASTODON_PEEK1 ) || 
		 ( nActivity == ACT_MASTODON_PEEK_SIGHTED ) || 
		 ( nActivity == ACT_MASTODON_SHOVE_PHYSOBJECT ) || 
		 ( nActivity == ACT_MASTODON_PHYSHIT_FR ) || 
		 ( nActivity == ACT_MASTODON_PHYSHIT_FL ) || 
		 ( nActivity == ACT_MASTODON_PHYSHIT_RR ) || 
		 ( nActivity == ACT_MASTODON_PHYSHIT_RL ) || 
		 ( nActivity == ACT_MASTODON_CHARGE_CRASH ) || 
		 ( nActivity == ACT_MASTODON_CHARGE_HIT ) ||
		 ( nActivity == ACT_MASTODON_CHARGE_ANTICIPATION ) )
	{
		return false;
	}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseMastodon::UpdateHead( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseMastodon::MaintainPhysicsTarget( void )
{
	if ( m_hPhysicsTarget == NULL || GetEnemy() == NULL )
		return;
	...
	{
		ClearCondition( COND_MASTODON_PHYSICS_TARGET );
		SetCondition( COND_MASTODON_PHYSICS_TARGET_INVALID );
		m_hPhysicsTarget = NULL;
		return;
	}
	else
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseMastodon::UpdatePhysicsTarget( bool bPreferObjectsAlongTargetVector, float flRadius )
{
	if ( GetEnemy() == NULL )
		return;
	...
	criteria.flTargetCone = MASTODON_OBJECTFINDING_FOV;
...
//-----------------------------------------------------------------------------
bool CBaseMastodon::ShouldProbeCollideAgainstEntity( CBaseEntity *pEntity )
{
	...
	if ( pEntity->GetMoveType() == MOVETYPE_VPHYSICS )
	{
		...
		if( pPhysObj && pPhysObj->GetMass() <= MASTODON_MAX_OBJECT_MASS )
		{
			return false;
		}
	}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseMastodon::PrescheduleThink( void )
{
	...
	if ( IsCurSchedule( SCHED_MASTODON_CHASE_ENEMY ) || 
		 IsCurSchedule( SCHED_MASTODON_PATROL_RUN ) ||
		 IsCurSchedule( SCHED_MASTODON_CANT_ATTACK ) ||
		 IsCurSchedule( SCHED_MASTODON_CHASE_ENEMY_TOLERANCE ) )
	{
		bool bCheckAlongLine = ( IsCurSchedule( SCHED_MASTODON_CHASE_ENEMY ) || IsCurSchedule( SCHED_MASTODON_CHASE_ENEMY_TOLERANCE ) );
		UpdatePhysicsTarget( bCheckAlongLine );
	}
	else if ( !IsCurSchedule( SCHED_MASTODON_PHYSICS_ATTACK ) )
	{
		ClearCondition( COND_MASTODON_PHYSICS_TARGET );
		m_hPhysicsTarget = NULL;
	}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseMastodon::GatherConditions( void )
{
	BaseClass::GatherConditions();

	if ( CanSummon(false) )
	{
		SetCondition( COND_MASTODON_CAN_SUMMON );
	}
	else
	{
		ClearCondition( COND_MASTODON_CAN_SUMMON );
	}

	// Make sure our physics target is still valid
	MaintainPhysicsTarget();

	if( IsCurSchedule(SCHED_MASTODON_PHYSICS_ATTACK) )
	{
	...
	if ( GetEnemy() )
	{
		...
		{
			SetCondition( COND_MASTODON_CAN_CHARGE );
		}
		else
		{
			ClearCondition( COND_MASTODON_CAN_CHARGE );
		}
	}
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseMastodon::StopLoopingSounds()
{
	//Stop all sounds
...
// Input  : &inputdata - 
//-----------------------------------------------------------------------------
void CBaseMastodon::InputUnburrow( inputdata_t &inputdata )
{
	if ( IsAlive() == false )
		return;
	...
	SetSchedule( SCHED_MASTODON_UNBURROW );
...
// Output  :
//------------------------------------------------------------------------------
bool CBaseMastodon::IsUnreachable(CBaseEntity *pEntity)
{
...
//-----------------------------------------------------------------------------
Vector CBaseMastodon::GetPhysicsHitPosition( CBaseEntity *pObject, CBaseEntity *pTarget, Vector *vecTrajectory, float *flClearDistance )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
inline bool CBaseMastodon::CanStandAtPoint( const Vector &vecPos, Vector *pOut )
{
...
//-----------------------------------------------------------------------------
bool CBaseMastodon::CanStandAtShoveTarget( CBaseEntity *pShoveObject, CBaseEntity *pTarget, Vector *pOut )
{
...
//-----------------------------------------------------------------------------
CBaseEntity *CBaseMastodon::GetNextShoveTarget( CBaseEntity *pLastEntity, AISightIter_t &iter )
{
...
//-----------------------------------------------------------------------------
CBaseEntity *CBaseMastodon::FindPhysicsObjectTarget( const PhysicsObjectCriteria_t &criteria )
{
...
//-----------------------------------------------------------------------------
void CBaseMastodon::BuildScheduleTestBits( void )
{
	...
	if ( IsCurSchedule( SCHED_MASTODON_CHASE_ENEMY ) )
	{
		SetCustomInterruptCondition( COND_MASTODON_PHYSICS_TARGET );
		SetCustomInterruptCondition( COND_MASTODON_CAN_SUMMON );
	}

	// Interrupt if we've been given a charge target
	if ( IsCurSchedule( SCHED_MASTODON_CHARGE ) == false )
	{
		SetCustomInterruptCondition( COND_MASTODON_HAS_CHARGE_TARGET );
	}
...
//			magnitude - 
//-----------------------------------------------------------------------------
void CBaseMastodon::ImpactShock( const Vector &origin, float radius, float magnitude, CBaseEntity *pIgnored )
{
...
// Input  : *pTarget - 
//-----------------------------------------------------------------------------
void CBaseMastodon::ChargeDamage( CBaseEntity *pTarget )
{
	if ( pTarget == NULL )
		return;
	...
	float flDamage = ( pPlayer == NULL ) ? 250 : sk_trex_dmg_charge.GetFloat();
	
	// If it's being held by the player, break that bond
	Pickup_ForcePlayerToDropThisObject( pTarget );

	// Calculate the physics force
	ApplyMastodonChargeDamage( this, pTarget, flDamage );
}
...
// Input  : &inputdata - 
//-----------------------------------------------------------------------------
void CBaseMastodon::InputRagdoll( inputdata_t &inputdata )
{
	if ( IsAlive() == false )
		return;
...
//-----------------------------------------------------------------------------
void CBaseMastodon::InputEnablePreferPhysicsAttack( inputdata_t &inputdata )
{
...
//-----------------------------------------------------------------------------
void CBaseMastodon::InputDisablePreferPhysicsAttack( inputdata_t &inputdata )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
int CBaseMastodon::SelectFailSchedule( int failedSchedule, int failedTask, AI_TaskFailureCode_t taskFailCode )
{
	// Figure out what to do next
	if ( failedSchedule == SCHED_MASTODON_CHASE_ENEMY && HasCondition( COND_ENEMY_UNREACHABLE ) )
		return SelectUnreachableSchedule();
...
// Output : int
//-----------------------------------------------------------------------------
int CBaseMastodon::TranslateSchedule( int scheduleType )
{
	switch( scheduleType )
	{
	case SCHED_CHASE_ENEMY:
		return SCHED_MASTODON_CHASE_ENEMY;
		break;
	}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseMastodon::StartSounds( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseMastodon::InputEnableBark( inputdata_t &inputdata )
{
	m_bBarkEnabled = true;
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseMastodon::InputDisableBark( inputdata_t &inputdata )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseMastodon::DeathSound( const CTakeDamageInfo &info )
{
...
// Input  : &info - 
//-----------------------------------------------------------------------------
void CBaseMastodon::Event_Killed( const CTakeDamageInfo &info )
{
	BaseClass::Event_Killed( info );

	// Tell all of my antlions to burrow away, 'cos they fear the Freeman
	if ( m_iNumLiveRaptors )
	{
		CBaseEntity	*pSearch = NULL;

		// Iterate through all antlions and see if there are any orphans
		while ( ( pSearch = gEntList.FindEntityByClassname( pSearch, "npc_velociraptor" ) ) != NULL )
		{
			CNPC_Raptor *pRaptor = assert_cast<CNPC_Raptor *>(pSearch);

			// See if it's a live orphan
			if ( pRaptor && pRaptor->GetOwnerEntity() == NULL && pRaptor->IsAlive() )
			{
				g_EventQueue.AddEvent( pRaptor, "BurrowAway", RandomFloat(0.1, 2.0), this, this );
			}
		}	
	}
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseMastodon::CanBecomeRagdoll( void )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseMastodon::BecomeRagdollOnClient( const Vector &force )
{
	if ( !CanBecomeRagdoll() ) 
		return false;
	...
	if ( m_spawnflags & SF_MASTODON_SERVERSIDE_RAGDOLL )
	{
...
// Output :
//-----------------------------------------------------------------------------
bool CBaseMastodon::OverrideMoveFacing( const AILocalMoveGoal_t &move, float flInterval )
{
...
#ifdef HL2_EPISODIC
	else if ( GetEnemy() && IsCurSchedule( SCHED_MASTODON_CANT_ATTACK ) )
	{
	...
	else if ( GetEnemy() && GetNavigator()->GetMovementActivity() == ACT_RUN )
  	{
		...
		if ( ( UTIL_DistApprox( vecEnemyLKP, GetAbsOrigin() ) < 512 ) || IsCurSchedule( SCHED_MASTODON_PATROL_RUN ) )
		{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseMastodon::IsHeavyDamage( const CTakeDamageInfo &info )
{
	// Struck by blast
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseMastodon::IsLightDamage( const CTakeDamageInfo &info )
{
	return false;
}
...
// Input  : *pChild - 
//-----------------------------------------------------------------------------
void CBaseMastodon::InputSummonedAntlionDied( inputdata_t &inputdata )
{
	m_iNumLiveRaptors--;
	Assert( m_iNumLiveRaptors >= 0 );
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseMastodon::QueryHearSound( CSound *pSound )
{
...
//---------------------------------------------------------
bool CBaseMastodon::CNavigator::GetStoppingPath( CAI_WaypointList *pClippedWaypoints )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseMastodon::RememberFailedPhysicsTarget( CBaseEntity *pTarget )
{
	// Already in the list?
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseMastodon::HandleInteraction( int interactionType, void *data, CBaseCombatCharacter *sender )
{
	// Don't chase targets that other guards in our squad may be going after!
	if ( interactionType == g_interactionMastodonFoundPhysicsObject )
	{
	...
	if ( interactionType == g_interactionMastodonShovedPhysicsObject )
	{
...
//-----------------------------------------------------------------------------
void	CBaseMastodon::PopulatePoseParameters( void )
{
...
//-----------------------------------------------------------------------------
//unsigned char CNPC_TRex::GetBleedingLevel( void ) const
//{
...
void CNPC_TRex::Spawn( void )
{
	...
	*/
	...
	m_iHealth = sk_trex_health.GetFloat();
	m_iMaxHealth = m_iHealth;
	m_flFieldOfView	= TREX_FOV_NORMAL;
...
CNPC_Triceratops::CNPC_Triceratops( void )
{
}
...
void CNPC_Triceratops::Precache( void )
{
	PrecacheModel( TRICERATOPS_MODEL );
...
void CNPC_Triceratops::Spawn( void )
{
	Precache();

	SetModel( TRICERATOPS_MODEL );
	...
	*/
	...
	SetSolid( SOLID_OBB ); //SetSolid( SOLID_BBOX );
	AddSolidFlags( FSOLID_NOT_STANDABLE );
	SetMoveType( MOVETYPE_STEP );
	...
	m_iHealth = sk_triceratops_health.GetFloat();
	m_iMaxHealth = m_iHealth;
	m_flFieldOfView	= TRICERATOPS_FOV_NORMAL;
...
//LINK_ENTITY_TO_CLASS( npc_mastodon, CBaseMastodon );
LINK_ENTITY_TO_CLASS( npc_tyrannosaurus, CNPC_TRex );
LINK_ENTITY_TO_CLASS( npc_triceratops, CNPC_Triceratops );
...
AI_BEGIN_CUSTOM_NPC( npc_mastodon, CBaseMastodon )

	// Interactions	
	DECLARE_INTERACTION( g_interactionMastodonFoundPhysicsObject )
	DECLARE_INTERACTION( g_interactionMastodonShovedPhysicsObject )

	// Squadslots	
	DECLARE_SQUADSLOT( SQUAD_SLOT_MASTODON_CHARGE )

	//Tasks
	DECLARE_TASK( TASK_MASTODON_CHARGE )
	DECLARE_TASK( TASK_MASTODON_GET_PATH_TO_PHYSOBJECT )
	DECLARE_TASK( TASK_MASTODON_SHOVE_PHYSOBJECT )
	DECLARE_TASK( TASK_MASTODON_SUMMON )
	DECLARE_TASK( TASK_MASTODON_SET_FLINCH_ACTIVITY )
	DECLARE_TASK( TASK_MASTODON_GET_PATH_TO_CHARGE_POSITION )
	DECLARE_TASK( TASK_MASTODON_GET_PATH_TO_NEAREST_NODE )
	DECLARE_TASK( TASK_MASTODON_GET_CHASE_PATH_ENEMY_TOLERANCE )
	DECLARE_TASK( TASK_MASTODON_OPPORTUNITY_THROW )
	DECLARE_TASK( TASK_MASTODON_FIND_PHYSOBJECT )

	//Activities
	DECLARE_ACTIVITY( ACT_MASTODON_SEARCH )
	DECLARE_ACTIVITY( ACT_MASTODON_PEEK_FLINCH )
	DECLARE_ACTIVITY( ACT_MASTODON_PEEK_ENTER )
	DECLARE_ACTIVITY( ACT_MASTODON_PEEK_EXIT )
	DECLARE_ACTIVITY( ACT_MASTODON_PEEK1 )
	DECLARE_ACTIVITY( ACT_MASTODON_BARK )
	DECLARE_ACTIVITY( ACT_MASTODON_PEEK_SIGHTED )
	DECLARE_ACTIVITY( ACT_MASTODON_CHARGE_START )
	DECLARE_ACTIVITY( ACT_MASTODON_CHARGE_CANCEL )
	DECLARE_ACTIVITY( ACT_MASTODON_CHARGE_RUN )
	DECLARE_ACTIVITY( ACT_MASTODON_CHARGE_CRASH )
	DECLARE_ACTIVITY( ACT_MASTODON_CHARGE_STOP )
	DECLARE_ACTIVITY( ACT_MASTODON_CHARGE_HIT )
	DECLARE_ACTIVITY( ACT_MASTODON_CHARGE_ANTICIPATION )
	DECLARE_ACTIVITY( ACT_MASTODON_SHOVE_PHYSOBJECT )
	DECLARE_ACTIVITY( ACT_MASTODON_FLINCH_LIGHT )
	DECLARE_ACTIVITY( ACT_MASTODON_UNBURROW )
	DECLARE_ACTIVITY( ACT_MASTODON_ROAR )
	DECLARE_ACTIVITY( ACT_MASTODON_RUN_HURT )
	DECLARE_ACTIVITY( ACT_MASTODON_PHYSHIT_FR )
	DECLARE_ACTIVITY( ACT_MASTODON_PHYSHIT_FL )
	DECLARE_ACTIVITY( ACT_MASTODON_PHYSHIT_RR )	
	DECLARE_ACTIVITY( ACT_MASTODON_PHYSHIT_RL )		
	
	//Adrian: events go here
	DECLARE_ANIMEVENT( AE_MASTODON_CHARGE_HIT )
	DECLARE_ANIMEVENT( AE_MASTODON_SHOVE_PHYSOBJECT )
	DECLARE_ANIMEVENT( AE_MASTODON_SHOVE )
	DECLARE_ANIMEVENT( AE_MASTODON_FOOTSTEP_LIGHT )
	DECLARE_ANIMEVENT( AE_MASTODON_FOOTSTEP_HEAVY )
	DECLARE_ANIMEVENT( AE_MASTODON_CHARGE_EARLYOUT )
	DECLARE_ANIMEVENT( AE_MASTODON_VOICE_GROWL )
	DECLARE_ANIMEVENT( AE_MASTODON_VOICE_BARK )
	DECLARE_ANIMEVENT( AE_MASTODON_VOICE_PAIN )
	DECLARE_ANIMEVENT( AE_MASTODON_VOICE_SQUEEZE )
	DECLARE_ANIMEVENT( AE_MASTODON_VOICE_SCRATCH )
	DECLARE_ANIMEVENT( AE_MASTODON_VOICE_GRUNT )
	DECLARE_ANIMEVENT( AE_MASTODON_BURROW_OUT )
	DECLARE_ANIMEVENT( AE_MASTODON_VOICE_ROAR )

	DECLARE_CONDITION( COND_MASTODON_PHYSICS_TARGET )
	DECLARE_CONDITION( COND_MASTODON_PHYSICS_TARGET_INVALID )
	DECLARE_CONDITION( COND_MASTODON_HAS_CHARGE_TARGET )
	DECLARE_CONDITION( COND_MASTODON_CAN_SUMMON )
	DECLARE_CONDITION( COND_MASTODON_CAN_CHARGE )
	...
	(
		...
		"		TASK_STOP_MOVING						0"
		"		TASK_FACE_ENEMY							0"
		"		TASK_PLAY_SEQUENCE						ACTIVITY:ACT_MASTODON_BARK"
		"		TASK_MASTODON_SUMMON				0"
		"		TASK_MASTODON_OPPORTUNITY_THROW		0"
		"	"
		"	Interrupts"
		"		COND_HEAVY_DAMAGE"
	)
	...
	DEFINE_SCHEDULE
	(
		SCHED_MASTODON_CHARGE,

		"	Tasks"
		"		TASK_STOP_MOVING					0"
		"		TASK_SET_FAIL_SCHEDULE				SCHEDULE:SCHED_MASTODON_CHASE_ENEMY"
		"		TASK_FACE_ENEMY						0"
		"		TASK_MASTODON_CHARGE			0"
		""
		"	Interrupts"
		"		COND_TASK_FAILED"
		"		COND_HEAVY_DAMAGE"
	...
	(
		...
		"	Tasks"
		"		TASK_STOP_MOVING			0"
		"		TASK_PLAY_SEQUENCE			ACTIVITY:ACT_MASTODON_CHARGE_CRASH"
		""
		"	Interrupts"
		"		COND_TASK_FAILED"
		"		COND_HEAVY_DAMAGE"
	...
	( 
		...
		"	Tasks"
		"		TASK_SET_FAIL_SCHEDULE						SCHEDULE:SCHED_MASTODON_CHASE_ENEMY"
		"		TASK_MASTODON_GET_PATH_TO_PHYSOBJECT	0"
		"		TASK_RUN_PATH								0"
		"		TASK_WAIT_FOR_MOVEMENT						0"
		"		TASK_FACE_ENEMY								0"
		"		TASK_MASTODON_SHOVE_PHYSOBJECT			0"
		""
		"	Interrupts"
		"		COND_TASK_FAILED"
		"		COND_ENEMY_DEAD"
	...
	//==================================================
	// SCHED_FORCE_TREX_PHYSICS_ATTACK
	//==================================================
	...
	( 
		...
		"	Tasks"
		"		TASK_SET_FAIL_SCHEDULE						SCHEDULE:SCHED_MASTODON_CANT_ATTACK"
		"		TASK_MASTODON_FIND_PHYSOBJECT			0"
		"		TASK_SET_SCHEDULE							SCHEDULE:SCHED_MASTODON_PHYSICS_ATTACK"
		""
		"	Interrupts"
		"		COND_MASTODON_PHYSICS_TARGET"
		"		COND_HEAVY_DAMAGE"
	)

	//==================================================
	// SCHED_TREX_CANT_ATTACK
	...
	//==================================================
	// SCHED_TREX_PHYSICS_DAMAGE_HEAVY
	//==================================================
	...
	(
		...
		"		TASK_MASTODON_SET_FLINCH_ACTIVITY	0"
		""
		"	Interrupts"
	)
	...
	(
		...
		"	Tasks"
		"		TASK_PLAY_SEQUENCE			ACTIVITY:ACT_MASTODON_UNBURROW"
		""
		"	Interrupts"
	)

	//==================================================
	// SCHED_TREX_CHARGE_CANCEL
	//==================================================
	...
	(
		...
		"	Tasks"
		"		TASK_PLAY_SEQUENCE			ACTIVITY:ACT_MASTODON_CHARGE_CANCEL"
		""
		"	Interrupts"
	)
	
	//==================================================
	// SCHED_TREX_FIND_CHARGE_POSITION
	//==================================================
	...
	(
		...
		"	Tasks"
		"		TASK_MASTODON_GET_PATH_TO_CHARGE_POSITION	0"
		"		TASK_RUN_PATH									0"
		"		TASK_WAIT_FOR_MOVEMENT							0"
		"	"
		"	Interrupts"
	...
	//=========================================================
	// > SCHED_TREX_CHASE_ENEMY_TOLERANCE
	//=========================================================
	DEFINE_SCHEDULE
	(
		SCHED_MASTODON_CHASE_ENEMY_TOLERANCE,
		...
		"	Tasks"
		"		TASK_STOP_MOVING									0"
		"		TASK_SET_FAIL_SCHEDULE								SCHEDULE:SCHED_MASTODON_PATROL_RUN"
		"		TASK_MASTODON_GET_PATH_TO_NEAREST_NODE			500"
		"		TASK_RUN_PATH										0"
		"		TASK_WAIT_FOR_MOVEMENT								0"
		"		TASK_FACE_ENEMY										0"
		""
	...
	(
		...
		"		TASK_STOP_MOVING			0"
		"		TASK_FACE_ENEMY				0"
		"		TASK_PLAY_SEQUENCE			ACTIVITY:ACT_MASTODON_ROAR"
		"	"
		"	Interrupts"
		"		COND_HEAVY_DAMAGE"
	)
	...
	//==================================================
	// SCHED_TREX_TAKE_COVER_FROM_ENEMY
	//==================================================
	DEFINE_SCHEDULE
	(
		SCHED_MASTODON_TAKE_COVER_FROM_ENEMY,
