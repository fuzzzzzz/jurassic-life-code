...
//Debug visualization
ConVar	g_debug_raptor( "g_debug_raptor", "0" );

// base velociraptor stuff
ConVar	sk_raptor_health( "sk_raptor_health", "0" );
ConVar	sk_raptor_swipe_damage( "sk_raptor_swipe_damage", "0" );
ConVar	sk_raptor_jump_damage( "sk_raptor_jump_damage", "0" );
ConVar  sk_raptor_air_attack_dmg( "sk_raptor_air_attack_dmg", "0" );

#ifdef HL2_EPISODIC

// workers
#define RAPTOR_WORKERS_BURST() (true)
#define RAPTOR_WORKER_BURST_IS_POISONOUS() (true)

ConVar  sk_raptor_worker_burst_damage( "sk_raptor_worker_burst_damage", "50", FCVAR_NONE, "How much damage is inflicted by an velociraptor worker's death explosion." );
ConVar	sk_raptor_worker_health( "sk_raptor_worker_health", "0", FCVAR_NONE, "Hitpoints of an velociraptor worker. If 0, will use base velociraptor hitpoints."   );
//ConVar  sk_raptor_worker_spit_speed( "sk_raptor_worker_spit_speed", "0", FCVAR_NONE, "Speed at which an velociraptor spit grenade travels." );

// This must agree with the VelociraptorWorkerBurstRadius() function!
ConVar  sk_raptor_worker_burst_radius( "sk_raptor_worker_burst_radius", "160", FCVAR_NONE, "Effect radius of an velociraptor worker's death explosion."  );

#endif

ConVar  g_test_new_raptor_jump( "g_test_new_raptor_jump", "1", FCVAR_ARCHIVE );
ConVar	raptor_easycrush( "raptor_easycrush", "1" );
ConVar g_raptor_cascade_push( "g_raptor_cascade_push", "1", FCVAR_ARCHIVE );
 
ConVar g_debug_raptor_worker( "g_debug_raptor_worker", "0" );

extern ConVar bugbait_radius;

int AE_RAPTOR_WALK_FOOTSTEP;
int AE_RAPTOR_MELEE_HIT1;
int AE_RAPTOR_MELEE_HIT2;
int AE_RAPTOR_MELEE_POUNCE;
int AE_RAPTOR_FOOTSTEP_SOFT;
int AE_RAPTOR_FOOTSTEP_HEAVY;
int AE_RAPTOR_START_JUMP;
int AE_RAPTOR_BURROW_IN;
int AE_RAPTOR_BURROW_OUT;
int AE_RAPTOR_VANISH;
//int AE_RAPTOR_OPEN_WINGS;
//int AE_RAPTOR_CLOSE_WINGS;
int AE_RAPTOR_MELEE1_SOUND;
int AE_RAPTOR_MELEE2_SOUND;
int AE_RAPTOR_WORKER_EXPLODE_SCREAM;
int AE_RAPTOR_WORKER_EXPLODE_WARN;
int AE_RAPTOR_WORKER_EXPLODE;
int AE_RAPTOR_WORKER_SPIT;
int AE_RAPTOR_WORKER_DONT_EXPLODE;


//Attack range definitions
#define	RAPTOR_MELEE1_RANGE			70.0f //100.0f //64.0f

//#define	RAPTOR_MELEE1_RANGE_MIN		48.0f //64.0f
//#define	RAPTOR_MELEE1_RANGE_MAX		64.0f //64.0f
/*
#define	RAPTOR_MELEE2_RANGE			72.0f //72.0f
#define	RAPTOR_MELEE2_RANGE_MAX		180.0f //320.0f //256.0f
#define	RAPTOR_MELEE2_RANGE_MIN		72.0f //160.0f
*/


#define	RAPTOR_MELEE2_RANGE		32.0f //72.0f
#define	RAPTOR_MELEE2_RANGE_MAX	175.0f
#define	RAPTOR_MELEE2_RANGE_MIN	72.0f

#define	RAPTOR_JUMP_MIN				72.0f //64.0f
#define	RAPTOR_JUMP_MAX_RISE		64.0f //128.0f //256.0f
#define	RAPTOR_JUMP_MAX			128.0f	// 256.0f //320.0f //512.0f

#define	RAPTOR_MIN_BUGBAIT_GOAL_TARGET_RADIUS	512

//Interaction IDs
int g_interactionRaptorFoundTarget = 0;
int g_interactionRaptorFiredAtTarget = 0;

#define	RAPTOR_MODEL			"models/jl/dinosaurs/velociraptor.mdl"
#define RAPTOR_WORKER_MODEL	"models/jl/dinosaurs/velociraptor.mdl"

#define	RAPTOR_BURROW_IN	0
#define	RAPTOR_BURROW_OUT	1

#define	RAPTOR_BUGBAIT_NAV_TOLERANCE	200

#define	RAPTOR_OBEY_FOLLOW_TIME	5.0f

// NPC damage adjusters
ConVar	sk_raptor_head( "sk_raptor_head","2" );
ConVar	sk_raptor_chest( "sk_raptor_chest","1" );
ConVar	sk_raptor_stomach( "sk_raptor_stomach","1" );
ConVar	sk_raptor_arm( "sk_raptor_arm","1" );
ConVar	sk_raptor_leg( "sk_raptor_leg","1" );

//==================================================
// VelociraptorSquadSlots
//==================================================

enum
{	
	SQUAD_SLOT_RAPTOR_JUMP = LAST_SHARED_SQUADSLOT,
	SQUAD_SLOT_RAPTOR_WORKER_FIRE,
};
...
int ACT_RAPTOR_JUMP_START;
int	ACT_RAPTOR_DISTRACT;
int ACT_RAPTOR_DISTRACT_ARRIVED;
int ACT_RAPTOR_BURROW_IN;
int ACT_RAPTOR_BURROW_OUT;
int ACT_RAPTOR_BURROW_IDLE;
int	ACT_RAPTOR_RUN_AGITATED;
int ACT_RAPTOR_FLIP;
int ACT_RAPTOR_ZAP_FLIP;
int ACT_RAPTOR_POUNCE;
int ACT_RAPTOR_POUNCE_MOVING;
int ACT_RAPTOR_DROWN;
int ACT_RAPTOR_LAND;
int ACT_RAPTOR_WORKER_EXPLODE;
int ACT_RAPTOR_FALL_TO_GROUND;

//==================================================
// CNPC_Raptor
//==================================================

CNPC_Raptor::CNPC_Raptor( void )
{
	m_flIdleDelay	= 0.0f;
	m_flBurrowTime	= 0.0f;
	m_flJumpTime	= 0.0f;
...
LINK_ENTITY_TO_CLASS( npc_velociraptor, CNPC_Raptor );

//==================================================
// CNPC_Raptor::m_DataDesc
//==================================================

BEGIN_DATADESC( CNPC_Raptor )
...
void CNPC_Raptor::Spawn( void )
{
	...
	SetHullType( HULL_HUMAN/* HULL_WIDE_SHORT */ );
	//SetHullSizeNormal();
	SetDefaultEyeOffset();
	
	SetNavType( NAV_GROUND );

	m_NPCState	= NPC_STATE_IDLE; // idle/none

#if HL2_EPISODIC
	m_iHealth = ( IsWorker() ) ? sk_raptor_worker_health.GetFloat() : sk_raptor_health.GetFloat();
#else
	m_iHealth	= sk_raptor_health.GetFloat();
#endif // _DEBUG

	SetSolid( SOLID_BBOX ); //OBB_YAW ); // VPHYSICS ); //SOLID_OBB );
	AddSolidFlags( FSOLID_CUSTOMRAYTEST ); //FSOLID_NOT_STANDABLE ); //| FSOLID_CUSTOMBOXTEST );
	...
	SetCollisionGroup( HL2COLLISION_GROUP_ANTLION ); // fix me

	CapabilitiesAdd( bits_CAP_MOVE_GROUND | bits_CAP_MOVE_JUMP | bits_CAP_INNATE_MELEE_ATTACK1 | bits_CAP_INNATE_MELEE_ATTACK2 | bits_CAP_TURN_HEAD );
	...
	if ( HasSpawnFlags( SF_RAPTOR_USE_GROUNDCHECKS ) == false )
	...
	// velociraptors will always pursue
	...
	if ( m_bStartBurrowed )
	{
		...
		SetActivity( (Activity) ACT_RAPTOR_BURROW_IDLE );
		SetSchedule( SCHED_RAPTOR_WAIT_FOR_UNBORROW_TRIGGER );

		SetUse( &CNPC_Raptor::BurrowUse );
	}

	BaseClass::Spawn();

	//m_nSkin = random->RandomInt( 0, RAPTOR_SKIN_COUNT-1 ); // fix me
}

//-----------------------------------------------------------------------------
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Raptor::Activate( void )
{
...
//-----------------------------------------------------------------------------
// Purpose: override this to simplify the physics shadow of the velociraptors
//-----------------------------------------------------------------------------
bool CNPC_Raptor::CreateVPhysics()
{
...
// Use all the gibs
#define	NUM_RAPTOR_GIBS_UNIQUE	3
const char *pszRaptorGibs_Unique[NUM_RAPTOR_GIBS_UNIQUE] = {
	"models/gibs/antlion_gib_large_1.mdl",
	"models/gibs/antlion_gib_large_2.mdl",
	"models/gibs/antlion_gib_large_3.mdl"
};

#define	NUM_RAPTOR_GIBS_MEDIUM	3
const char *pszRaptorGibs_Medium[NUM_RAPTOR_GIBS_MEDIUM] = {
...
#define	NUM_RAPTOR_GIBS_SMALL	3
const char *pszRaptorGibs_Small[NUM_RAPTOR_GIBS_SMALL] = {
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Raptor::Precache( void )
{
#ifdef HL2_EPISODIC
	if ( IsWorker() )
	{
		PrecacheModel( RAPTOR_WORKER_MODEL );
		PropBreakablePrecacheAll( MAKE_STRING( RAPTOR_WORKER_MODEL ) );
...
#endif // HL2_EPISODIC
	{
		PrecacheModel( RAPTOR_MODEL );
		PropBreakablePrecacheAll( MAKE_STRING( RAPTOR_MODEL ) );
		PrecacheParticleSystem( "blood_impact_antlion_01" );
		PrecacheParticleSystem( "AntlionGib" );
	}

	for ( int i = 0; i < NUM_RAPTOR_GIBS_UNIQUE; ++i )
	{
		PrecacheModel( pszRaptorGibs_Unique[ i ] );
	}
	for ( int i = 0; i < NUM_RAPTOR_GIBS_MEDIUM; ++i )
	{
		PrecacheModel( pszRaptorGibs_Medium[ i ] );
	}
	for ( int i = 0; i < NUM_RAPTOR_GIBS_SMALL; ++i )
	{
		PrecacheModel( pszRaptorGibs_Small[ i ] );
	}

	PrecacheScriptSound( "NPC_Raptor.RunOverByVehicle" );
	PrecacheScriptSound( "NPC_Raptor.MeleeAttack" );
	m_hFootstep = PrecacheScriptSound( "NPC_Raptor.Footstep" );
	PrecacheScriptSound( "NPC_Raptor.BurrowIn" );
	PrecacheScriptSound( "NPC_Raptor.BurrowOut" );
	PrecacheScriptSound( "NPC_Raptor.FootstepSoft" );
	PrecacheScriptSound( "NPC_Raptor.FootstepHeavy" );
	PrecacheScriptSound( "NPC_Raptor.MeleeAttackSingle" );
	PrecacheScriptSound( "NPC_Raptor.MeleeAttackDouble" );
	PrecacheScriptSound( "NPC_Raptor.Distracted" );
	PrecacheScriptSound( "NPC_Raptor.Idle" );
	PrecacheScriptSound( "NPC_Raptor.Pain" );
	PrecacheScriptSound( "NPC_Raptor.Land" );
	//PrecacheScriptSound( "NPC_Raptor.WingsOpen" );
	PrecacheScriptSound( "NPC_Raptor.LoopingAgitated" );
	PrecacheScriptSound( "NPC_Raptor.Distracted" );

#ifdef HL2_EPISODIC
	PrecacheScriptSound( "NPC_Raptor.PoisonBurstScream" );
	PrecacheScriptSound( "NPC_Raptor.PoisonBurstScreamSubmerged" );
	PrecacheScriptSound( "NPC_Raptor.PoisonBurstExplode" );
	PrecacheScriptSound( "NPC_Raptor.MeleeAttack_Muffled" );
	PrecacheScriptSound( "NPC_Raptor.TrappedMetal" );
	PrecacheScriptSound( "NPC_Raptor.ZappedFlip" );
	PrecacheScriptSound( "NPC_Raptor.PoisonShoot" );
	PrecacheScriptSound( "NPC_Raptor.PoisonBall" );
#endif
...
//-----------------------------------------------------------------------------
inline CBaseEntity *CNPC_Raptor::EntityToWatch( void )
{
...
//-----------------------------------------------------------------------------
void	CNPC_Raptor::PopulatePoseParameters( void )
{
...
//---------------------------------------------------------
float CNPC_Raptor::GetHitgroupDamageMultiplier( int iHitGroup, const CTakeDamageInfo &info )
{
	switch( iHitGroup )
	{
...
//		return 1.0f;
	...
	case HITGROUP_HEAD:
		return sk_raptor_head.GetFloat();

	case HITGROUP_CHEST:
		return sk_raptor_chest.GetFloat();

	case HITGROUP_STOMACH:
		return sk_raptor_stomach.GetFloat();

	case HITGROUP_LEFTARM:
	case HITGROUP_RIGHTARM:
		return sk_raptor_arm.GetFloat();

	case HITGROUP_LEFTLEG:
	case HITGROUP_RIGHTLEG:
		return sk_raptor_leg.GetFloat();
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Raptor::UpdateHead( void )
{
...
#define	RAPTOR_VIEW_FIELD_NARROW	0.85f
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Raptor::FInViewCone( CBaseEntity *pEntity )
{
	m_flFieldOfView = ( GetEnemy() != NULL ) ? RAPTOR_VIEW_FIELD_NARROW : VIEW_FIELD_WIDE;
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Raptor::FInViewCone( const Vector &vecSpot )
{
	m_flFieldOfView = ( GetEnemy() != NULL ) ? RAPTOR_VIEW_FIELD_NARROW : VIEW_FIELD_WIDE;
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
bool CNPC_Raptor::CanBecomeRagdoll()
{
...
#ifdef HL2_EPISODIC
	if ( IsWorker() && RAPTOR_WORKERS_BURST() )
	{
...
// Input  : *pVictim - 
//-----------------------------------------------------------------------------
void CNPC_Raptor::Event_Killed( const CTakeDamageInfo &info )
{
	//Turn off wings
	//SetWings( false );
	VacateStrategySlot();

	if ( IsCurSchedule(SCHED_RAPTOR_BURROW_IN) || IsCurSchedule(SCHED_RAPTOR_BURROW_OUT) )
	{
	...
	if ( pAttacker && pAttacker->GetServerVehicle() && ShouldGib( info ) == true )
	{
		...
		EmitSound( filter, entindex(), "NPC_Raptor.RunOverByVehicle" );
	}
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void CNPC_Raptor::MeleeAttack( float distance, float damage, QAngle &viewPunch, Vector &shove )
{
	Vector vecForceDir;
	...
	if ( pHurt )
	{
		...
		EmitSound( "NPC_Raptor.MeleeAttack" );
	}
}

// Number of times the velociraptors will attempt to generate a random chase position
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Raptor::FindChasePosition( const Vector &targetPos, Vector &result )
{
	if ( HasSpawnFlags( SF_RAPTOR_USE_GROUNDCHECKS ) == true )
	{
		 result = targetPos;
		 return true;
	}
...
// Input  : &testPos - 
//-----------------------------------------------------------------------------
bool CNPC_Raptor::GetGroundPosition( const Vector &testPos, Vector &result )
{
...
void CNPC_Raptor::ManageFleeCapabilities( bool bEnable )
{
	if ( bEnable == false )
	{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Raptor::GetPathToSoundFleePoint( int soundType )
{
	...
	hintCriteria.SetHintType( HINT_RAPTOR_DANGER_FLEE_POINT );
	...
	// Put the sound location on the same plane as the velociraptor.
	...
	if ( pHint != NULL )
	{
		...
		AI_NavGoal_t goal( vecFleeGoal, (Activity) ACT_RAPTOR_RUN_AGITATED, 128, AIN_DEF_FLAGS );
		...
		if ( GetNavigator()->SetGoal( goal ) )
		{
			...
			GetNavigator()->SetArrivalActivity( (Activity) ACT_RAPTOR_DISTRACT_ARRIVED );
	...
	// Find a route to that position
	AI_NavGoal_t goal( vecFleeGoal + Vector( 0, 0, 8 ), (Activity) ACT_RAPTOR_RUN_AGITATED, 512, AIN_DEF_FLAGS );
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Raptor::SeenEnemyWithinTime( float flTime )
{
...
//-----------------------------------------------------------------------------
// Purpose: Test whether this velociraptor can hit the target
//-----------------------------------------------------------------------------
bool CNPC_Raptor::InnateWeaponLOSCondition( const Vector &ownerPos, const Vector &targetPos, bool bSetConditions )
{
...
Vector VecCheckThrowTolerance( CBaseEntity *pEdict, const Vector &vecSpot1, Vector vecSpot2, float flSpeed, float flTolerance )
{
	...
	{
		// fail!
		if ( g_debug_raptor_worker.GetBool() )
		{
...
bool CNPC_Raptor::GetSpitVector( const Vector &vecStartPos, const Vector &vecTarget, Vector *vecOut )
{
	// velociraptor workers exist only in episodic.
#if HL2_EPISODIC
	// Try the most direct route
	Vector vecToss = VecCheckThrowTolerance( this, vecStartPos, vecTarget, sk_raptor_worker_spit_speed.GetFloat(), (10.0f*12.0f) );

	// If this failed then try a little faster (flattens the arc)
	if ( vecToss == vec3_origin )
	{
		vecToss = VecCheckThrowTolerance( this, vecStartPos, vecTarget, sk_raptor_worker_spit_speed.GetFloat() * 1.5f, (10.0f*12.0f) );
		if ( vecToss == vec3_origin )
			return false;
	}
...
// Input  : flDuration - 
//-----------------------------------------------------------------------------
void CNPC_Raptor::DelaySquadAttack( float flDuration )
{
	if ( GetSquad() )
	{
		...
		GetSquad()->BroadcastInteraction( g_interactionRaptorFiredAtTarget, (void *)&flAdjDuration, this );
	}
}
...
// Input  : *pEvent - 
//-----------------------------------------------------------------------------
void CNPC_Raptor::HandleAnimEvent( animevent_t *pEvent )
{
#ifdef HL2_EPISODIC
		...
		if ( pEvent->event == AE_ANTLION_WORKER_SPIT )
		{
			if ( GetEnemy() )
			{
				...
				EmitSound( "NPC_Raptor.PoisonShoot" );
			}
			return;
		}
		*/
		
		if ( pEvent->event == AE_RAPTOR_WORKER_DONT_EXPLODE )
		{
			m_bDontExplode = true;
			return;
		}
	...
	if ( pEvent->event == AE_RAPTOR_WALK_FOOTSTEP )
	{
		MakeAIFootstepSound( 240.0f );
		EmitSound( "NPC_Raptor.Footstep", m_hFootstep, pEvent->eventtime );
		return;
	}

	if ( pEvent->event == AE_RAPTOR_MELEE_HIT1 )
	{
		MeleeAttack( RAPTOR_MELEE1_RANGE, sk_raptor_swipe_damage.GetFloat(), QAngle( 20.0f, 0.0f, -12.0f ), Vector( -250.0f, 1.0f, 1.0f ) );
		return;
	}

	if ( pEvent->event == AE_RAPTOR_MELEE_HIT2 )
	{
		MeleeAttack( RAPTOR_MELEE1_RANGE, sk_raptor_swipe_damage.GetFloat(), QAngle( 20.0f, 0.0f, 0.0f ), Vector( -350.0f, 1.0f, 1.0f ) );
		return;
	}

	if ( pEvent->event == AE_RAPTOR_MELEE_POUNCE )
	{
		MeleeAttack( RAPTOR_MELEE2_RANGE, sk_raptor_swipe_damage.GetFloat(), QAngle( 4.0f, 0.0f, 0.0f ), Vector( -250.0f, 1.0f, 1.0f ) );
		return;
	}
		
//	if ( pEvent->event == AE_RAPTOR_OPEN_WINGS )
//	{
//		SetWings( true );
//		return;
//	}

//	if ( pEvent->event == AE_RAPTOR_CLOSE_WINGS )
//	{
//		SetWings( false );
//		return;
//	}

	if ( pEvent->event == AE_RAPTOR_VANISH )
	{
		AddSolidFlags( FSOLID_NOT_SOLID );
		m_takedamage	= DAMAGE_NO;
		AddEffects( EF_NODRAW );
	...
	if ( pEvent->event == AE_RAPTOR_BURROW_IN )
	{
		//Burrowing sound
		EmitSound( "NPC_Raptor.BurrowIn" );
	...
	if ( pEvent->event == AE_RAPTOR_BURROW_OUT )
	{
		EmitSound( "NPC_Raptor.BurrowOut" );
	...
	if ( pEvent->event == AE_RAPTOR_FOOTSTEP_SOFT )
	{
		EmitSound( "NPC_Raptor.FootstepSoft", pEvent->eventtime );
		return;
	}

	if ( pEvent->event == AE_RAPTOR_FOOTSTEP_HEAVY )
	{
		EmitSound( "NPC_Raptor.FootstepHeavy", pEvent->eventtime );
		return;
	}
	
	
	if ( pEvent->event == AE_RAPTOR_MELEE1_SOUND )
	{
		EmitSound( "NPC_Raptor.MeleeAttackSingle" );
		return;
	}
	
	if ( pEvent->event == AE_RAPTOR_MELEE2_SOUND )
	{
		EmitSound( "NPC_Raptor.MeleeAttackDouble" );
		return;
	}

	if ( pEvent->event == AE_RAPTOR_START_JUMP )
	{
		StartJump();
		return;
	}

	// Velociraptor worker events
#if HL2_EPISODIC
	if ( pEvent->event == AE_RAPTOR_WORKER_EXPLODE_SCREAM )
	{
		if ( GetWaterLevel() < 2 )
		{
			EmitSound( "NPC_Raptor.PoisonBurstScream" );
		}
		else
		{
			EmitSound( "NPC_Raptor.PoisonBurstScreamSubmerged" );
		}
		return;
	}

	if ( pEvent->event == AE_RAPTOR_WORKER_EXPLODE_WARN )
	{
		CSoundEnt::InsertSound( SOUND_PHYSICS_DANGER, GetAbsOrigin(), sk_raptor_worker_burst_radius.GetFloat(), 0.5f, this );
		return;
	}

	if ( pEvent->event == AE_RAPTOR_WORKER_EXPLODE )
	{
		CTakeDamageInfo info( this, this, sk_raptor_worker_burst_damage.GetFloat(), DMG_BLAST_SURFACE | ( RAPTOR_WORKER_BURST_IS_POISONOUS() ? DMG_POISON : DMG_ACID ) );
		Event_Gibbed( info );
		return;
	}
#endif
...
bool CNPC_Raptor::IsUnusableNode(int iNodeID, CAI_Hint *pHint)
{
	bool iBaseReturn = BaseClass::IsUnusableNode( iNodeID, pHint );

	if ( g_test_new_raptor_jump.GetBool() == 0 )
		 return iBaseReturn;
...
void CNPC_Raptor::LockJumpNode( void )
{
	if ( HasSpawnFlags( SF_RAPTOR_USE_GROUNDCHECKS ) == false )
		 return;
	...
	if ( g_test_new_raptor_jump.GetBool() == false )
		 return;
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
bool CNPC_Raptor::OnObstructionPreSteer( AILocalMoveGoal_t *pMoveGoal, float distClear, AIMoveResult_t *pResult )
{
	...
	if ( pBlocker && pBlocker->Classify() == CLASS_RAPTOR )
	{
		// HACKHACK
		CNPC_Raptor *pRaptor = dynamic_cast< CNPC_Raptor * > ( pBlocker );

		if ( pRaptor )
		{
			if ( pRaptor->AllowedToBePushed() == true && GetEnemy() == NULL )
			{
				//NDebugOverlay::Box( pRaptor->GetAbsOrigin(), GetHullMins(), GetHullMaxs(), 0, 255, 0, 0, 2 );
				pRaptor->GetMotor()->SetIdealYawToTarget( WorldSpaceCenter() );
				pRaptor->SetSchedule( SCHED_MOVE_AWAY );
				pRaptor->m_flNextJumpPushTime = gpGlobals->curtime + 2.0f;
			}
		}
	}
...
bool NPC_Raptor_IsRaptor( CBaseEntity *pEntity )
{
	CNPC_Raptor *pRaptor = dynamic_cast<CNPC_Raptor *>(pEntity);

	return pRaptor ? true : false;
}

class CTraceFilterRaptor : public CTraceFilterEntitiesOnly
{
public:
	CTraceFilterRaptor( const CBaseEntity *pEntity ) { m_pIgnore = pEntity; }
	...
	virtual bool ShouldHitEntity( IHandleEntity *pHandleEntity, int contentsMask )
	{
		...
		if ( NPC_Raptor_IsRaptor( pEntity ) )
			 return true;
...
// Purpose:  
//-----------------------------------------------------------------------------
void CNPC_Raptor::StartTask( const Task_t *pTask )
{
	switch ( pTask->iTask ) 
	{
	case TASK_RAPTOR_FIND_COVER_FROM_SAVEPOSITION:
		{
			Vector coverPos;
	...
	case TASK_RAPTOR_FACE_JUMP:
		break;

	case TASK_RAPTOR_HOP_OFF_NPC:
		{
	...
	case TASK_RAPTOR_REACH_FIGHT_GOAL:

		m_OnReachFightGoal.FireOutput( this, this );
		TaskComplete();
		break;

	case TASK_RAPTOR_DISMOUNT_NPC:
		{
			...
			{
				trace_t trace;
				CTraceFilterRaptor traceFilter( this );
				...
				ResetActivity();
				SetActivity( (Activity) ACT_RAPTOR_FLIP );
			}
			else
			{
				// Dead or gone now
	...
	case TASK_RAPTOR_GET_PATH_TO_BUGBAIT:
		{
			//Must have a saved sound
			//FIXME: This isn't assured to be still pointing to the right place, need to protect this
			if ( !m_bHasHeardSound )
			...
			{
				AI_NavGoal_t goal( goalPos, (Activity) ACT_RAPTOR_RUN_AGITATED, RAPTOR_BUGBAIT_NAV_TOLERANCE );
				...
				if ( GetNavigator()->SetGoal( goal, AIN_DISCARD_IF_FAIL ) == false )
				{
					...
					AI_NavGoal_t nearGoal( GOALTYPE_LOCATION_NEAREST_NODE, goalPos, (Activity) ACT_RAPTOR_RUN_AGITATED, RAPTOR_BUGBAIT_NAV_TOLERANCE );
					...
					{
						TaskFail( "Velociraptor failed to find path to bugbait position\n" );
						return;
					}
				}
				else
	...
	case TASK_RAPTOR_WAIT_FOR_TRIGGER:
		m_flIdleDelay = gpGlobals->curtime + 1.0f;

		break;

	case TASK_RAPTOR_JUMP:
	...
	case TASK_RAPTOR_CHECK_FOR_UNBORROW:
	...
	case TASK_RAPTOR_FIND_BURROW_IN_POINT:
		
		if ( FindBurrow( GetAbsOrigin(), pTask->flTaskData, RAPTOR_BURROW_IN ) == false )
		{
			TaskFail( "TASK_RAPTOR_FIND_BURROW_IN_POINT: Unable to find burrow in position\n" );
		}
		else
		{
			TaskComplete();
	...
	case TASK_RAPTOR_FIND_BURROW_OUT_POINT:
		
		if ( FindBurrow( GetAbsOrigin(), pTask->flTaskData, RAPTOR_BURROW_OUT ) == false )
		{
			TaskFail( "TASK_RAPTOR_FIND_BURROW_OUT_POINT: Unable to find burrow out position\n" );
		}
		else
		{
			TaskComplete();
	...
	case TASK_RAPTOR_BURROW:
		Burrow();
		TaskComplete();

		break;

	case TASK_RAPTOR_UNBURROW:
		Unburrow();
		TaskComplete();

		break;

	case TASK_RAPTOR_VANISH:
		AddEffects( EF_NODRAW );
		AddFlag( FL_NOTARGET );
		m_spawnflags |= SF_NPC_GAG;
		...
		if ( pTask->flTaskData )
		{
			...
			SetThink( &CNPC_Raptor::SUB_Remove );
	...
	case TASK_RAPTOR_GET_DANGER_ESCAPE_PATH:
		{
	...
	case TASK_RAPTOR_GET_PHYSICS_DANGER_ESCAPE_PATH:
		{
...
// Input  : *pTask - 
//-----------------------------------------------------------------------------
void CNPC_Raptor::RunTask( const Task_t *pTask )
{
	...
	case TASK_RAPTOR_CHECK_FOR_UNBORROW:
		...
		// This deals with issues where the game relies out Velociraptor spawners
...
bool CNPC_Raptor::AllowedToBePushed( void )
{
	if ( IsCurSchedule( SCHED_RAPTOR_BURROW_WAIT ) || 
		IsCurSchedule(SCHED_RAPTOR_BURROW_IN) || 
		IsCurSchedule(SCHED_RAPTOR_BURROW_OUT) ||
		IsCurSchedule(SCHED_RAPTOR_BURROW_AWAY ) ||
		IsCurSchedule( SCHED_RAPTOR_RUN_TO_FIGHT_GOAL ) )
		return false;

	if ( IsRunningDynamicInteraction() )
		return false;

	if ( IsMoving() == false && IsCurSchedule( SCHED_RAPTOR_FLIP ) == false
...
// Output :
//-----------------------------------------------------------------------------
bool CNPC_Raptor::IsJumpLegal( const Vector &startPos, const Vector &apex, const Vector &endPos ) const
{
	const float MAX_JUMP_RISE		= 128; //256;//512;
	const float MAX_JUMP_DROP		= 256; //512;
	const float MAX_JUMP_DISTANCE	= 512; //1024;
	const float MIN_JUMP_DISTANCE   = 64; //128;

	if ( CRaptorRepellant::IsPositionRepellantFree( endPos ) == false )
		 return false;
	...
	if ( HasSpawnFlags( SF_RAPTOR_USE_GROUNDCHECKS ) && g_test_new_raptor_jump.GetBool() == true )
	{
		trace_t	tr;
		...
		if ( tr.m_pEnt )
		{
			...
			if ( pBlocker && pBlocker->Classify() == CLASS_RAPTOR )
			{
				...
				if ( pRaptor )
				{
					if ( pRaptor->AllowedToBePushed() == true )
					{
					//	NDebugOverlay::Line( GetAbsOrigin(), endPos, 255, 0, 0, 0, 2 );
					//	NDebugOverlay::Box( pRaptor->GetAbsOrigin(), GetHullMins(), GetHullMaxs(), 0, 0, 255, 0, 2 );
						pRaptor->GetMotor()->SetIdealYawToTarget( endPos );
						pRaptor->SetSchedule( SCHED_MOVE_AWAY );
						pRaptor->m_flNextJumpPushTime = gpGlobals->curtime + 2.0f;
					}
				}
...
bool CNPC_Raptor::IsFirmlyOnGround( void )
{
	if( !( GetFlags()&FL_ONGROUND ) )
		return false;
...
// Purpose: 
//-----------------------------------------------------------------------------
int CNPC_Raptor::SelectFailSchedule( int failedSchedule, int failedTask, AI_TaskFailureCode_t taskFailCode )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Raptor::ShouldJump( void )
{
	if ( GetEnemy() == NULL )
		return false;
	...
	UTIL_PredictedPosition( GetEnemy(), flDot * 2.5f, &vecPredictedPos );  // 2.5f default value

	// Don't jump if we're already near the target
	if ( ( GetAbsOrigin() - vecPredictedPos ).LengthSqr() < (512*512) ) // 512*512 default
		return false;
	...
	if (flDist < RAPTOR_JUMP_MIN)
		return false;

	Vector	targetPos = vecPredictedPos + ( targetDir * (GetHullWidth()*4.0f) );

	if ( CRaptorRepellant::IsPositionRepellantFree( targetPos ) == false )
		 return false;
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
Activity CNPC_Raptor::NPC_TranslateActivity( Activity baseAct )
{
	// Workers explode as long as they didn't drown.
	if ( IsWorker() && ( baseAct == ACT_DIESIMPLE ) && !m_bDontExplode )
	{
		return ( Activity )ACT_RAPTOR_WORKER_EXPLODE;
	}
...
int CNPC_Raptor::ChooseMoveSchedule( void )
{
	...
	if ( ShouldResumeFollow() )
	{
		...
		//if ( pMaker != NULL )
		//{
		//	pMaker->SetChildMoveState( RAPTOR_MOVE_FOLLOW );
		//}
	}
			...
			if ( m_hFightGoalTarget )
			{
				...
				if ( targetDist > 256 )
				{
					...
					if ( FindChasePosition( targetPos, testPos ) )
					{
						...
						return SCHED_RAPTOR_RUN_TO_FIGHT_GOAL;
					}
				}
			}
		}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Raptor::ZapThink( void )
{
	CEffectData	data;
	...
	{
		SetContextThink( &CNPC_Raptor::ZapThink, gpGlobals->curtime + random->RandomFloat( 0.05f, 0.25f ), "ZapThink" );
	}
	else
	{
		SetContextThink( NULL, gpGlobals->curtime, "ZapThink" );
...
*/
	//Flipped?
	if ( HasCondition( COND_RAPTOR_FLIPPED ) )
	{
		ClearCondition( COND_RAPTOR_FLIPPED );
		
		// See if it's a forced, electrical flip
		if ( m_flZapDuration > gpGlobals->curtime )
		{
			SetContextThink( &CNPC_Raptor::ZapThink, gpGlobals->curtime, "ZapThink" );
			return SCHED_RAPTOR_ZAP_FLIP;
		}

		// Regular flip
		return SCHED_RAPTOR_FLIP;
	}

	if( HasCondition( COND_RAPTOR_IN_WATER ) )
	{
		// No matter what, drown in water
		return SCHED_RAPTOR_DROWN;
	}

	// If we're flagged to burrow away when eluded, do so
	if ( ( m_spawnflags & SF_RAPTOR_BURROW_ON_ELUDED ) && ( HasCondition( COND_ENEMY_UNREACHABLE ) || HasCondition( COND_ENEMY_TOO_FAR ) ) )
		return SCHED_RAPTOR_BURROW_AWAY;
	...
	if ( HasCondition( COND_HEAR_DANGER ) )
	{
		...
		if ( pSound )
		{
			...
			return SCHED_RAPTOR_FLEE_DANGER;
		}
	}
	...
	if( HasCondition( COND_HEAR_PHYSICS_DANGER ) )
	{
		CTakeDamageInfo info;
		PainSound( info );
		return SCHED_RAPTOR_FLEE_PHYSICS_DANGER;
	}
	
	//On another NPC's head?
/*	if( HasCondition( COND_RAPTOR_ON_NPC ) )
	{
		// You're on an NPC's head. Get off.
		//return SCHED_RAPTOR_DISMOUNT_NPC; // it kill the raptor // red
		return SCHED_RAPTOR_FLIP;
	}
*/
	if( HasCondition( COND_RAPTOR_ILLEGAL_GROUNDENT ) )
	{
		// You're on an NPC's head. Get off.
		return SCHED_RAPTOR_HOP_RANDOMLY;
	}

	// If we're scripted to jump at a target, do so
	if ( HasCondition( COND_RAPTOR_CAN_JUMP_AT_TARGET ) )
	{
		// NDebugOverlay::Cross3D( m_vecSavedJump, 32.0f, 255, 0, 0, true, 2.0f );
		ClearCondition( COND_RAPTOR_CAN_JUMP_AT_TARGET );
		return SCHED_RAPTOR_JUMP;
	}
	...
	if ( HasCondition( COND_HEAR_BUGBAIT ) && ( m_bIgnoreBugbait == false ) )
	{
		...
		{
			EmitSound( "NPC_Raptor.Distracted" );
		...
		{		
			...
			return SCHED_RAPTOR_CHASE_BUGBAIT;
		}
	}
	...
	case NPC_STATE_COMBAT:
		{
			...
			if ( hl2_episodic.GetBool() && IsWorker() )
			{
				...
				{
					m_flPounceTime = gpGlobals->curtime + 1.5f; //1.5f;

					if ( m_bLeapAttack == true )
						return SCHED_RAPTOR_POUNCE_MOVING;

					return SCHED_RAPTOR_POUNCE;
				}
				
				// A squadmate died, so run away!
				if ( HasCondition( COND_RAPTOR_SQUADMATE_KILLED ) )
				{
					SetNextAttack( gpGlobals->curtime + random->RandomFloat( 2.0f, 4.0f ) );
					ClearCondition( COND_RAPTOR_SQUADMATE_KILLED );
					return SCHED_RAPTOR_TAKE_COVER_FROM_ENEMY;
				}
				...
				{
					if ( OccupyStrategySlot( SQUAD_SLOT_RAPTOR_WORKER_FIRE ) )
					{
						EmitSound( "NPC_Raptor.PoisonBurstScream" );
						...
						return SCHED_RAPTOR_WORKER_RANGE_ATTACK1;
					}
				}
			...
			else
			{
				...
				// Try to jump
				if ( HasCondition( COND_RAPTOR_CAN_JUMP ) )
					return SCHED_RAPTOR_JUMP;
			}
		}
		break;
	...
	default:
		{
			...
			if ( GetEnemy() == NULL && ( HasCondition( COND_LIGHT_DAMAGE ) || HasCondition( COND_HEAVY_DAMAGE ) ) )
			{
				...
				if ( FInViewCone( vecEnemyLKP ) )
				{
					...
					return SCHED_RAPTOR_TAKE_COVER_FROM_SAVEPOSITION;
				}
...
void CNPC_Raptor::Ignite ( float flFlameLifetime, bool bNPCOnly, float flSize, bool bCalledByLevelDesigner )
{
#ifdef HL2_EPISODIC
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
int CNPC_Raptor::OnTakeDamage_Alive( const CTakeDamageInfo &info )
{
	CTakeDamageInfo newInfo = info;


	if ( newInfo.GetDamageType() & DMG_BUCKSHOT )
	{
		...
		AddGesture( ACT_GESTURE_FLINCH_CHEST );
	
	}

	if( hl2_episodic.GetBool() && raptor_easycrush.GetBool() )
	{
...
//-----------------------------------------------------------------------------
// Purpose: Velociraptor who are flipped will knock over other Velociraptors behind them!
//-----------------------------------------------------------------------------
void CNPC_Raptor::CascadePush( const Vector &vecForce )
{
	// Controlled via this convar until this is proven worthwhile
	if ( hl2_episodic.GetBool() == false /*|| g_raptor_cascade_push.GetBool() == false*/ )
		return;
	...
	// Make Velociraptors flip all around us!
	...
	{
		// We only care about Velociraptors
		if ( pEnemySearch[i] == NULL || pEnemySearch[i]->Classify() != CLASS_RAPTOR || pEnemySearch[i] == this )
			continue;

		CNPC_Raptor *pRaptor = dynamic_cast<CNPC_Raptor *>(pEnemySearch[i]);
		if ( pRaptor != NULL )
		{
			Vector vecDir = ( pRaptor->GetAbsOrigin() - GetAbsOrigin() );
			vecDir[2] = 0.0f;
			...
			pRaptor->ApplyAbsVelocityImpulse( vecDir );
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
inline bool CNPC_Raptor::IsFlipped( void ) 
{
	return ( GetActivity() == ACT_RAPTOR_FLIP || GetActivity() == ACT_RAPTOR_ZAP_FLIP );
}

//-----------------------------------------------------------------------------
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Raptor::TraceAttack( const CTakeDamageInfo &info, const Vector &vecDir, trace_t *ptr, CDmgAccumulator *pAccumulator )
{
	CTakeDamageInfo newInfo = info;
		...
		if ( !IsRunningDynamicInteraction() )
 		{
			...
			if( hl2_episodic.GetBool() )
			{
				...
				if( GetFlags() & FL_ONGROUND )
				{
					...
					SetCondition( COND_RAPTOR_FLIPPED );
				}
...
void CNPC_Raptor::StopLoopingSounds( void )
{
	//if ( m_bLoopingStarted )
	//{
	//	StopSound( "NPC_Raptor.WingsOpen" );
	//	m_bLoopingStarted = false;
	//}
	if ( m_bAgitatedSound )
	{
		StopSound( "NPC_Raptor.LoopingAgitated" );
		m_bAgitatedSound = false;
	}
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Raptor::IdleSound( void )
{
	EmitSound( "NPC_Raptor.Idle" );
	m_flIdleDelay = gpGlobals->curtime + 4.0f;
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Raptor::PainSound( const CTakeDamageInfo &info )
{
	EmitSound( "NPC_Raptor.Pain" );
}
...
// Output : 
//-----------------------------------------------------------------------------
float CNPC_Raptor::GetIdealAccel( void ) const
{
...
// Output : float
//-----------------------------------------------------------------------------
float CNPC_Raptor::MaxYawSpeed( void )
{
	switch ( GetActivity() )
	{
	case ACT_IDLE:		
	...
	case ACT_WALK:
		...
		break;
	case ACT_RUN:
		return 312.0f; //256.0f; //64.0f;
		break;
	
	case ACT_TURN_LEFT:
	case ACT_TURN_RIGHT:
		return 26.0f; //28.0f; //32.0f;
		break;
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Raptor::ShouldPlayIdleSound( void )
{
...
// Input  : *pFriend - 
//-----------------------------------------------------------------------------
void CNPC_Raptor::NotifyDeadFriend( CBaseEntity *pFriend )
{
	SetCondition( COND_RAPTOR_SQUADMATE_KILLED );
...
//-----------------------------------------------------------------------------
bool CNPC_Raptor::FCanCheckAttacks( void )
{
	if ( IsWorker() )
	{
...
// Purpose: 
//-----------------------------------------------------------------------------
int CNPC_Raptor::RangeAttack1Conditions( float flDot, float flDist )
{
	if ( GetNextAttack() > gpGlobals->curtime )
...
// Purpose: 
//-----------------------------------------------------------------------------
int CNPC_Raptor::MeleeAttack1Conditions( float flDot, float flDist )
{
#if 1 //NOTENOTE: Use predicted position melee attacks

	//Get our likely position in one half second
	Vector vecPrPos;
	UTIL_PredictedPosition( GetEnemy(), 0.5f, &vecPrPos ); //0.5f;

	//Get the predicted distance and direction
	float flPrDist = ( vecPrPos - GetAbsOrigin() ).LengthSqr();
	if ( flPrDist > Square( RAPTOR_MELEE1_RANGE ) )
		return COND_TOO_FAR_TO_ATTACK;

	
//	if ( flPrDist < Square( RAPTOR_MELEE1_RANGE_MIN ) )
//		return COND_TOO_CLOSE_TO_ATTACK;
	...
	float flAdjustedDist = RAPTOR_MELEE1_RANGE;
...
// Output : int
//-----------------------------------------------------------------------------
int CNPC_Raptor::MeleeAttack2Conditions( float flDot, float flDist )
{
	...
	if ( ( flPrDist > RAPTOR_MELEE2_RANGE_MAX ) )
	{
		m_flPounceTime = gpGlobals->curtime + 0.2f;
		return COND_TOO_FAR_TO_ATTACK;
	}
	else if ( ( flPrDist < RAPTOR_MELEE2_RANGE_MIN ) )
	{
		m_flPounceTime = gpGlobals->curtime + 0.2f;
		return COND_TOO_CLOSE_TO_ATTACK;
	}
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Raptor::HandleInteraction( int interactionType, void *data, CBaseCombatCharacter *sender )
{
	//Check for a target found while burrowed
	if ( interactionType == g_interactionRaptorFoundTarget )
	{
	...
	if ( interactionType == g_interactionRaptorFiredAtTarget )
	{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Raptor::StartJump( void )
{
...
//-----------------------------------------------------------------------------
bool CNPC_Raptor::FValidateHintType( CAI_Hint *pHint )
{
	switch ( m_iContext )
	{
	case RAPTOR_BURROW_OUT:
		{			
...
// Input  : &origin - 
//-----------------------------------------------------------------------------
void CNPC_Raptor::ClearBurrowPoint( const Vector &origin )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Raptor::ValidBurrowPoint( const Vector &point )
{
	trace_t	tr;
...
//-----------------------------------------------------------------------------
// Purpose: Finds a burrow point for the Velociraptor
// Input  : distance - radius to search for burrow spot in
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Raptor::FindBurrow( const Vector &origin, float distance, int type, bool excludeNear )
{
	//Burrowing in?
	if ( type == RAPTOR_BURROW_IN )
	{
		//Attempt to find a burrowing point
		CHintCriteria	hintCriteria;

		hintCriteria.SetHintType( HINT_RAPTOR_BURROW_POINT );
		hintCriteria.SetFlag( bits_HINT_NODE_NEAREST );
...
//-----------------------------------------------------------------------------
// Purpose:	Cause the Velociraptor to unborrow
// Input  : *pActivator - 
//			*pCaller - 
//			useType - 
//			value - 
...
void CNPC_Raptor::BurrowUse( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
	...
	SetSchedule( SCHED_RAPTOR_WAIT_UNBORROW );
}

//-----------------------------------------------------------------------------
// Purpose: Monitor the Velociraptor's jump to play the proper landing sequence
//-----------------------------------------------------------------------------
bool CNPC_Raptor::CheckLanding( void )
{
	trace_t	tr;
	Vector	testPos;
	...
	{
		int	sequence = SelectWeightedSequence( (Activity)ACT_RAPTOR_LAND );

		if ( GetSequence() != sequence )
		{
			//SetWings( false );
			VacateStrategySlot();
			SetIdealActivity( (Activity) ACT_RAPTOR_LAND );

			CreateDust( false );
			EmitSound( "NPC_Raptor.Land" );
			...
			if ( GetEnemy() && GetEnemy()->IsPlayer()  )
			{
				...
				if ( pPlayer && pPlayer->IsInAVehicle() == false )
					 MeleeAttack( RAPTOR_MELEE1_RANGE, sk_raptor_swipe_damage.GetFloat(), QAngle( 4.0f, 0.0f, 0.0f ), Vector( -250.0f, 1.0f, 1.0f ) );
			}
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Raptor::QuerySeeEntity( CBaseEntity *pEntity, bool bOnlyHateOrFearIfNPC )
{
...
/*
//-----------------------------------------------------------------------------
// Purpose: Turns the Velociraptor's wings on or off
// Input  : state - on or off
//-----------------------------------------------------------------------------
void CNPC_Raptor::SetWings( bool state )
{
	...
	if ( m_bWingsOpen )
	{
		CPASAttenuationFilter filter( this, "NPC_Raptor.WingsOpen" );
		filter.MakeReliable();

		EmitSound( filter, entindex(), "NPC_Raptor.WingsOpen" );
		SetBodygroup( 1, 1 );
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Raptor::Unburrow( void )
{
	m_bStartBurrowed = false;
	//SetWings( false );
...
// Input  : &inputdata - 
//-----------------------------------------------------------------------------
void CNPC_Raptor::InputUnburrow( inputdata_t &inputdata )
{
	if ( IsAlive() == false )
		return;
...
// Input  : &inputdata - 
//-----------------------------------------------------------------------------
void CNPC_Raptor::InputBurrow( inputdata_t &inputdata )
{
	if ( IsAlive() == false )
		return;

	SetSchedule( SCHED_RAPTOR_BURROW_IN );
}
...
// Input  : &inputdata - 
//-----------------------------------------------------------------------------
void CNPC_Raptor::InputBurrowAway( inputdata_t &inputdata )
{
	if ( IsAlive() == false )
		return;

	SetSchedule( SCHED_RAPTOR_BURROW_AWAY );
}

//-----------------------------------------------------------------------------
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Raptor::CreateDust( bool placeDecal )
{
	trace_t	tr;
...
// Input  : *pSound - 
//-----------------------------------------------------------------------------
bool CNPC_Raptor::QueryHearSound( CSound *pSound )
{
...
//-----------------------------------------------------------------------------
void CNPC_Raptor::BuildScheduleTestBits( void )
{
	...
	{
		SetCustomInterruptCondition( COND_RAPTOR_CAN_JUMP );
		SetCustomInterruptCondition( COND_ENEMY_UNREACHABLE );
	}

	if( !IsCurSchedule(SCHED_RAPTOR_HOP_RANDOMLY) )
	{
		SetCustomInterruptCondition( COND_RAPTOR_ILLEGAL_GROUNDENT );
	}
	else
	{
		ClearCustomInterruptCondition( COND_RAPTOR_ILLEGAL_GROUNDENT );
	}

	if ( !IsCurSchedule( SCHED_RAPTOR_DROWN ) )
	{
		// Interrupt any schedule unless already drowning.
		SetCustomInterruptCondition( COND_RAPTOR_IN_WATER );
	}
	else
	{
		// Don't stop drowning just because you're in water!
		ClearCustomInterruptCondition( COND_RAPTOR_IN_WATER );
	}
	...
	if( !IsCurSchedule(SCHED_RAPTOR_FLEE_DANGER)			&& 	
		!IsCurSchedule(SCHED_RAPTOR_FLEE_PHYSICS_DANGER)	&& 		
		!IsCurSchedule(SCHED_RAPTOR_BURROW_IN)				&& 		
		!IsCurSchedule(SCHED_RAPTOR_WAIT_UNBORROW)			&& 		
		!IsCurSchedule(SCHED_RAPTOR_BURROW_OUT)			&&
		!IsCurSchedule(SCHED_RAPTOR_BURROW_WAIT)			&&
		!IsCurSchedule(SCHED_RAPTOR_WAIT_FOR_UNBORROW_TRIGGER)&&
		!IsCurSchedule(SCHED_RAPTOR_WAIT_FOR_CLEAR_UNBORROW)&&
		!IsCurSchedule(SCHED_RAPTOR_WAIT_UNBORROW)			&&
		!IsCurSchedule(SCHED_RAPTOR_JUMP)					&&
		!IsCurSchedule(SCHED_RAPTOR_FLIP)					&&
		!IsCurSchedule(SCHED_RAPTOR_DISMOUNT_NPC)			&& 
		( GetFlags() & FL_ONGROUND ) )
	{
		// Only do these if not jumping as well
		if (!IsCurSchedule(SCHED_RAPTOR_JUMP))
		{
			if ( GetEnemy() == NULL )
			{
			...
			SetCustomInterruptCondition( COND_RAPTOR_FLIPPED );
			SetCustomInterruptCondition( COND_RAPTOR_CAN_JUMP_AT_TARGET );

			if ( GetNavType() != NAV_JUMP )
				 SetCustomInterruptCondition( COND_RAPTOR_RECEIVED_ORDERS );
		}

	//	SetCustomInterruptCondition( COND_RAPTOR_ON_NPC );
	}
}
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Raptor::IsValidEnemy( CBaseEntity *pEnemy )
{
	//See if Velociraptors are friendly to the player in this map
	...
	if ( IsCurSchedule( GetGlobalScheduleId( SCHED_RAPTOR_CHASE_BUGBAIT ) ) && ( GetNavigator() != NULL ) )
	{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Raptor::GatherConditions( void )
{
...
/*	CBaseEntity *pGroundEnt = GetGroundEntity();
	...
	{
		SetCondition( COND_RAPTOR_ON_NPC );
	}
	else
	{
		ClearCondition( COND_RAPTOR_ON_NPC );
	}
/*
...
/*	if ( m_hFollowTarget != NULL )
	{
		...
		if ( targetDist > 400 )
		{
			SetCondition( COND_RAPTOR_FOLLOW_TARGET_TOO_FAR );
		}
		else
		{
			ClearCondition( COND_RAPTOR_FOLLOW_TARGET_TOO_FAR );
		}
	}*/

	if ( IsCurSchedule( SCHED_RAPTOR_BURROW_WAIT ) == false && 
		 IsCurSchedule(SCHED_RAPTOR_BURROW_IN) == false && 
		 IsCurSchedule(SCHED_RAPTOR_BURROW_OUT) == false && 
		 ...
		 IsEffectActive( EF_NODRAW ) == false )
	{
		...
		{
			// Start Drowning!
			SetCondition( COND_RAPTOR_IN_WATER );
		}
	}

	//Ignore the player pushing me if I'm flipped over!
	if ( IsCurSchedule( SCHED_RAPTOR_FLIP ) )
		 ClearCondition( COND_PLAYER_PUSHING );

	ClearCondition( COND_RAPTOR_ILLEGAL_GROUNDENT );
	CBaseEntity *ground = GetGroundEntity();
	if( (GetFlags() & FL_ONGROUND) && ground && !ground->IsWorld() )
	{
		if( ( ground->IsNPC() || ground->IsPlayer() ) )
		{
			SetCondition( COND_RAPTOR_ILLEGAL_GROUNDENT );
		}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Raptor::PrescheduleThink( void )
{
	UpdateHead();
	...
	if ( ( eActivity == ACT_RAPTOR_RUN_AGITATED ) && ( m_bAgitatedSound == false ) )
	{
		//Start sound
		CPASAttenuationFilter filter( this, "NPC_Raptor.LoopingAgitated" );
		filter.MakeReliable();

		EmitSound( filter, entindex(), "NPC_Raptor.LoopingAgitated" );
		m_bAgitatedSound = true;
	}
	else if ( ( eActivity != ACT_RAPTOR_RUN_AGITATED ) && ( m_bAgitatedSound == true ) )
	{
		//Stop sound
		StopSound( "NPC_Raptor.LoopingAgitated" );
		m_bAgitatedSound = false;
	...
	/*
	if (    //( m_bWingsOpen ) &&
			( eActivity != ACT_RAPTOR_JUMP_START ) && 
			( eActivity != ACT_JUMP ) && 
			( eActivity != ACT_GLIDE ) && 
			( eActivity != ACT_RAPTOR_LAND ) && 
			( eActivity != ACT_RAPTOR_DISTRACT ))
	{
		//SetWings( false );
	}
	*/
	...
	if ( IsEffectActive( EF_NODRAW ) &&
		 ( eActivity != ACT_RAPTOR_BURROW_IDLE ) &&
		 ( eActivity != ACT_RAPTOR_BURROW_OUT ) &&
		 ( eActivity != ACT_RAPTOR_BURROW_IN) )
	{
		DevMsg( "Velociraptor failed to unburrow properly!\n" );
		Assert( 0 );
		RemoveEffects( EF_NODRAW );
		RemoveSolidFlags( FSOLID_NOT_SOLID );
		m_takedamage	= DAMAGE_YES;
	...
	if ( ShouldJump() )
	{
		SetCondition( COND_RAPTOR_CAN_JUMP );
	}
	else
	{
		ClearCondition( COND_RAPTOR_CAN_JUMP );
	}
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Raptor::IsLightDamage( const CTakeDamageInfo &info )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Raptor::IsAllied( void )
{
	return ( GlobalEntity_GetState( "velociraptor_allied" ) == GLOBAL_ON );
}
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Raptor::ShouldResumeFollow( void )
{
	if ( IsAllied() == false )
		return false;

	if ( m_MoveState == RAPTOR_MOVE_FOLLOW || m_hFollowTarget == NULL )
		return false;
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Raptor::ShouldAbandonFollow( void )
{
...
// Input  : *pTarget - 
//-----------------------------------------------------------------------------
void CNPC_Raptor::SetFightTarget( CBaseEntity *pTarget )
{
	m_hFightGoalTarget = pTarget;

	SetCondition( COND_RAPTOR_RECEIVED_ORDERS );
}
...
// Input  : &inputdata - 
//-----------------------------------------------------------------------------
void CNPC_Raptor::InputFightToPosition( inputdata_t &inputdata )
{
	if ( IsAlive() == false )
		return;
...
// Input  : &inputdata - 
//-----------------------------------------------------------------------------
void CNPC_Raptor::InputStopFightToPosition( inputdata_t &inputdata )
{
	SetFightTarget( NULL );
}
...
// Input  : *pEnemy - 
//-----------------------------------------------------------------------------
void CNPC_Raptor::GatherEnemyConditions( CBaseEntity *pEnemy )
{
	// Do the base class
	BaseClass::GatherEnemyConditions( pEnemy );

	// Only continue if we burrow when eluded
	if ( ( m_spawnflags & SF_RAPTOR_BURROW_ON_ELUDED ) == false )
		return;
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Raptor::ShouldGib( const CTakeDamageInfo &info )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Raptor::CorpseGib( const CTakeDamageInfo &info )
{
#ifdef HL2_EPISODIC
...
#endif // HL2_EPISODIC
	{
		...
		if ( s_nBodyBone == -1 )
		{
			s_nBodyBone = LookupBone( "Velociraptor.Body_Bone" );
		}
...
// Input  : *pOther - 
//-----------------------------------------------------------------------------
void CNPC_Raptor::Touch( CBaseEntity *pOther )
{
	...
	if ( pPlayer && pPlayer->IsInAVehicle() )
	{
		...
		if ( pVehicleEnt == pOther )
		{
			...
			if ( pDrivableVehicle != NULL )
			{
				...
				bool bBurrowingOut = IsCurSchedule( SCHED_RAPTOR_BURROW_OUT );
	...
	// in episodic, an Velociraptor colliding with the player in midair does him damage.
	...
	{
		CTakeDamageInfo	dmgInfo( this, this, sk_raptor_air_attack_dmg.GetInt(), DMG_SLASH );
	...
	if ( pOther->IsPlayer() )
	{
		...
		if ( !IsCurSchedule( SCHED_MOVE_AWAY ) && !IsCurSchedule( SCHED_RAPTOR_BURROW_OUT ) )
...
// Output :
//-----------------------------------------------------------------------------
bool CNPC_Raptor::OverrideMoveFacing( const AILocalMoveGoal_t &move, float flInterval )
{
	if ( hl2_episodic.GetBool() )
	{
	...
	//Adrian: Make Velociraptors face the danger (ai_sound) while they flee away.
	if ( IsCurSchedule( SCHED_RAPTOR_FLEE_DANGER ) )
	{
		CSound *pSound = GetLoudestSoundOfType( SOUND_DANGER );
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Raptor::InputDisableJump( inputdata_t &inputdata )
{
	m_bDisableJump = true;
	CapabilitiesRemove( bits_CAP_MOVE_JUMP );
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Raptor::InputEnableJump( inputdata_t &inputdata )
{
	m_bDisableJump = false;
	CapabilitiesAdd( bits_CAP_MOVE_JUMP );
}
...
// Input  : *pTarget - 
//-----------------------------------------------------------------------------
void CNPC_Raptor::SetFollowTarget( CBaseEntity *pTarget )
{
	m_FollowBehavior.SetFollowTarget( pTarget );
	m_hFollowTarget = pTarget;
	m_flObeyFollowTime = gpGlobals->curtime + RAPTOR_OBEY_FOLLOW_TIME;
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Raptor::CreateBehaviors( void )
{
...
// Input  : &inputdata - 
//-----------------------------------------------------------------------------
void CNPC_Raptor::InputIgnoreBugbait( inputdata_t &inputdata )
{
...
// Input  : &inputdata - 
//-----------------------------------------------------------------------------
void CNPC_Raptor::InputHearBugbait( inputdata_t &inputdata )
{
...
// Input  : state - 
//-----------------------------------------------------------------------------
void CNPC_Raptor::SetMoveState( RaptorMoveState_e state )
{
	m_MoveState = state;
...
//-----------------------------------------------------------------------------
// Purpose: Special version helps other NPCs hit overturned Velociraptor
//-----------------------------------------------------------------------------
Vector CNPC_Raptor::BodyTarget( const Vector &posSrc, bool bNoisy /*= true*/ )
{ 
	// Cache the bone away to avoid future lookups
	if ( m_nBodyBone == -1 )
	{
		CBaseAnimating *pAnimating = GetBaseAnimating();
		m_nBodyBone = pAnimating->LookupBone( "pelvis" );
	}
...
//-----------------------------------------------------------------------------
// Purpose: Flip the Velociraptor over
//-----------------------------------------------------------------------------
void CNPC_Raptor::Flip( bool bZapped /*= false*/ )
{
	// We can't flip an already flipped Velociraptor
	if ( IsFlipped() )
		return;
	...
	if ( bZapped )
	{
		m_flZapDuration = gpGlobals->curtime + SequenceDuration( SelectWeightedSequence( (Activity) ACT_RAPTOR_ZAP_FLIP) ) + 0.1f;

		EmitSound( "NPC_Raptor.ZappedFlip"  );
	}
}
...
// Input  : &inputdata - 
//-----------------------------------------------------------------------------
void CNPC_Raptor::InputJumpAtTarget( inputdata_t &inputdata )
{
	...
	SetCondition( COND_RAPTOR_CAN_JUMP_AT_TARGET );
}
...
// workers can explode.
//-----------------------------------------------------------------------------
void CNPC_Raptor::DoPoisonBurst()
{
	if ( GetWaterLevel() < 2 )
	{
		CTakeDamageInfo info( this, this, sk_raptor_worker_burst_damage.GetFloat(), DMG_BLAST_SURFACE | ( RAPTOR_WORKER_BURST_IS_POISONOUS() ? DMG_POISON : DMG_ACID ) );

		RadiusDamage( info, GetAbsOrigin(), sk_raptor_worker_burst_radius.GetFloat(), CLASS_NONE, this );
	...
	EmitSound( "NPC_Raptor.PoisonBurstExplode" );
}
#endif
...
// Purpose: 
//-----------------------------------------------------------------------------
bool CNPC_Raptor::IsHeavyDamage( const CTakeDamageInfo &info )
{
	if ( hl2_episodic.GetBool() && IsWorker() )
	{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Raptor::CanRunAScriptedNPCInteraction( bool bForced /*= false*/ )
{
...
// Save/Restore
//---------------------------------------------------------
BEGIN_DATADESC( CRaptorRepellant )
...
static CUtlVector< CHandle< CRaptorRepellant > >m_hRepellantList;


CRaptorRepellant::~CRaptorRepellant()
{
	m_hRepellantList.FindAndRemove( this );
}

void CRaptorRepellant::Spawn( void )
{
	BaseClass::Spawn();
	m_bEnabled = true;
...
void CRaptorRepellant::InputEnable( inputdata_t &inputdata )
{
	m_bEnabled = true;
...
void CRaptorRepellant::InputDisable( inputdata_t &inputdata )
{
	m_bEnabled = false;
	m_hRepellantList.FindAndRemove( this );
}

float CRaptorRepellant::GetRadius( void )
{
	if ( m_bEnabled == false )
		 return 0.0f;
...
void CRaptorRepellant::OnRestore( void )
{
	BaseClass::OnRestore();
...
bool CRaptorRepellant::IsPositionRepellantFree( Vector vDesiredPos )
{
	for ( int i = 0; i < m_hRepellantList.Count(); i++ )
	{
		if ( m_hRepellantList[i] )
		{
			CRaptorRepellant *pRep = m_hRepellantList[i].Get();
...
LINK_ENTITY_TO_CLASS( point_velociraptor_repellant, CRaptorRepellant);
...
AI_BEGIN_CUSTOM_NPC( npc_velociraptor, CNPC_Raptor )

	//Register our interactions
	DECLARE_INTERACTION( g_interactionRaptorFoundTarget )
	DECLARE_INTERACTION( g_interactionRaptorFiredAtTarget )

	//Conditions
	DECLARE_CONDITION( COND_RAPTOR_FLIPPED )
	//DECLARE_CONDITION( COND_RAPTOR_ON_NPC )
	DECLARE_CONDITION( COND_RAPTOR_CAN_JUMP )
	DECLARE_CONDITION( COND_RAPTOR_FOLLOW_TARGET_TOO_FAR )
	DECLARE_CONDITION( COND_RAPTOR_RECEIVED_ORDERS )
	DECLARE_CONDITION( COND_RAPTOR_IN_WATER )
	DECLARE_CONDITION( COND_RAPTOR_CAN_JUMP_AT_TARGET )
	DECLARE_CONDITION( COND_RAPTOR_SQUADMATE_KILLED )
	DECLARE_CONDITION( COND_RAPTOR_ILLEGAL_GROUNDENT )
		
	//Squad slots
	DECLARE_SQUADSLOT( SQUAD_SLOT_RAPTOR_JUMP )
	DECLARE_SQUADSLOT( SQUAD_SLOT_RAPTOR_WORKER_FIRE )

	//Tasks
	DECLARE_TASK( TASK_RAPTOR_SET_CHARGE_GOAL )
	DECLARE_TASK( TASK_RAPTOR_BURROW )
	DECLARE_TASK( TASK_RAPTOR_UNBURROW )
	DECLARE_TASK( TASK_RAPTOR_VANISH )
	DECLARE_TASK( TASK_RAPTOR_FIND_BURROW_IN_POINT )
	DECLARE_TASK( TASK_RAPTOR_FIND_BURROW_OUT_POINT )
	DECLARE_TASK( TASK_RAPTOR_BURROW_WAIT )
	DECLARE_TASK( TASK_RAPTOR_CHECK_FOR_UNBORROW )
	DECLARE_TASK( TASK_RAPTOR_JUMP )
	DECLARE_TASK( TASK_RAPTOR_WAIT_FOR_TRIGGER )
	DECLARE_TASK( TASK_RAPTOR_GET_DANGER_ESCAPE_PATH ) 
	DECLARE_TASK( TASK_RAPTOR_GET_PATH_TO_BUGBAIT )
	DECLARE_TASK( TASK_RAPTOR_FACE_BUGBAIT )
	DECLARE_TASK( TASK_RAPTOR_DISMOUNT_NPC )
	DECLARE_TASK( TASK_RAPTOR_REACH_FIGHT_GOAL )
	DECLARE_TASK( TASK_RAPTOR_GET_PHYSICS_DANGER_ESCAPE_PATH )
	DECLARE_TASK( TASK_RAPTOR_FACE_JUMP )
	DECLARE_TASK( TASK_RAPTOR_DROWN )
	DECLARE_TASK( TASK_RAPTOR_GET_PATH_TO_RANDOM_NODE )
	DECLARE_TASK( TASK_RAPTOR_FIND_COVER_FROM_SAVEPOSITION )
	DECLARE_TASK( TASK_RAPTOR_HOP_OFF_NPC )

	//Activities
	DECLARE_ACTIVITY( ACT_RAPTOR_DISTRACT )
	DECLARE_ACTIVITY( ACT_RAPTOR_DISTRACT_ARRIVED )
	DECLARE_ACTIVITY( ACT_RAPTOR_JUMP_START )
	DECLARE_ACTIVITY( ACT_RAPTOR_BURROW_IN )
	DECLARE_ACTIVITY( ACT_RAPTOR_BURROW_OUT )
	DECLARE_ACTIVITY( ACT_RAPTOR_BURROW_IDLE )
	DECLARE_ACTIVITY( ACT_RAPTOR_RUN_AGITATED )
	DECLARE_ACTIVITY( ACT_RAPTOR_FLIP )
	DECLARE_ACTIVITY( ACT_RAPTOR_POUNCE )
	DECLARE_ACTIVITY( ACT_RAPTOR_POUNCE_MOVING )
	DECLARE_ACTIVITY( ACT_RAPTOR_DROWN )
	DECLARE_ACTIVITY( ACT_RAPTOR_LAND )
	DECLARE_ACTIVITY( ACT_RAPTOR_WORKER_EXPLODE )
	DECLARE_ACTIVITY( ACT_RAPTOR_ZAP_FLIP )
	DECLARE_ACTIVITY( ACT_RAPTOR_FALL_TO_GROUND )

	//Events
	DECLARE_ANIMEVENT( AE_RAPTOR_WALK_FOOTSTEP )
	DECLARE_ANIMEVENT( AE_RAPTOR_MELEE_HIT1 )
	DECLARE_ANIMEVENT( AE_RAPTOR_MELEE_HIT2 )
	DECLARE_ANIMEVENT( AE_RAPTOR_MELEE_POUNCE )
	DECLARE_ANIMEVENT( AE_RAPTOR_FOOTSTEP_SOFT )
	DECLARE_ANIMEVENT( AE_RAPTOR_FOOTSTEP_HEAVY )
	DECLARE_ANIMEVENT( AE_RAPTOR_START_JUMP )
	DECLARE_ANIMEVENT( AE_RAPTOR_BURROW_IN )
	DECLARE_ANIMEVENT( AE_RAPTOR_BURROW_OUT )
	DECLARE_ANIMEVENT( AE_RAPTOR_VANISH )
	//DECLARE_ANIMEVENT( AE_RAPTOR_OPEN_WINGS )
	//DECLARE_ANIMEVENT( AE_RAPTOR_CLOSE_WINGS )
	DECLARE_ANIMEVENT( AE_RAPTOR_MELEE1_SOUND )
	DECLARE_ANIMEVENT( AE_RAPTOR_MELEE2_SOUND )
	DECLARE_ANIMEVENT( AE_RAPTOR_WORKER_EXPLODE_SCREAM )
	DECLARE_ANIMEVENT( AE_RAPTOR_WORKER_EXPLODE_WARN )
	DECLARE_ANIMEVENT( AE_RAPTOR_WORKER_EXPLODE )
	DECLARE_ANIMEVENT( AE_RAPTOR_WORKER_SPIT )
	DECLARE_ANIMEVENT( AE_RAPTOR_WORKER_DONT_EXPLODE )
	...
	(
		...
		"	Tasks"
		"		TASK_RAPTOR_BURROW_WAIT		0"
		"		TASK_SET_SCHEDULE				SCHEDULE:SCHED_RAPTOR_WAIT_FOR_CLEAR_UNBORROW"
		""
		"	Interrupts"
		"		COND_TASK_FAILED"
	)
	...
	(
		...
		"	Tasks"
		"		TASK_SET_FAIL_SCHEDULE				SCHEDULE:SCHED_RAPTOR_BURROW_WAIT"
		"		TASK_RAPTOR_BURROW_WAIT			1"
		"		TASK_RAPTOR_FIND_BURROW_OUT_POINT	1024"
		"		TASK_SET_SCHEDULE					SCHEDULE:SCHED_RAPTOR_WAIT_FOR_CLEAR_UNBORROW"
		""
		"	Interrupts"
		"		COND_TASK_FAILED"
	...
	(
		...
		"		TASK_RAPTOR_BURROW					0"
		"		TASK_PLAY_SEQUENCE					ACTIVITY:ACT_RAPTOR_BURROW_IN"
		"		TASK_RAPTOR_VANISH					0"
		"		TASK_SET_SCHEDULE					SCHEDULE:SCHED_RAPTOR_BURROW_WAIT"
		""
		"	Interrupts"
		"		COND_TASK_FAILED"
	)
	...
	(
		...
		"		TASK_RAPTOR_FIND_BURROW_IN_POINT	512"
		"		TASK_RUN_PATH						0"
		"		TASK_WAIT_FOR_MOVEMENT				0"
		"		TASK_SET_SCHEDULE					SCHEDULE:SCHED_RAPTOR_BURROW_IN"
		""
		"	Interrupts"
		"		COND_TASK_FAILED"
		"		COND_GIVE_WAY"
	...
	(
		...
		"	Tasks"
		"		TASK_SET_FAIL_SCHEDULE			SCHEDULE:SCHED_RAPTOR_BURROW_WAIT"
		"		TASK_RAPTOR_UNBURROW			0"
		"		TASK_PLAY_SEQUENCE				ACTIVITY:ACT_RAPTOR_BURROW_OUT"
		""
		"	Interrupts"
		"		COND_TASK_FAILED"
	)
	...
	(
		...
		"	Tasks"
		"		TASK_RAPTOR_WAIT_FOR_TRIGGER	0"
		""
		"	Interrupts"
		"		COND_TASK_FAILED"
	)
	...
	(
		...
		"	Tasks"
		"		TASK_SET_FAIL_SCHEDULE				SCHEDULE:SCHED_RAPTOR_BURROW_WAIT"
		"		TASK_RAPTOR_CHECK_FOR_UNBORROW		1"
		"		TASK_SET_SCHEDULE					SCHEDULE:SCHED_RAPTOR_BURROW_OUT"
		""
		"	Interrupts"
		"		COND_TASK_FAILED"
	)
	...
	(
		...
		"		TASK_RAPTOR_GET_DANGER_ESCAPE_PATH	0"
		"		TASK_RUN_PATH							0"
		"		TASK_WAIT_FOR_MOVEMENT					0"
		"		TASK_STOP_MOVING						0"
		"		TASK_PLAY_SEQUENCE						ACTIVITY:ACT_RAPTOR_DISTRACT_ARRIVED"
		""
		"	Interrupts"
		"		COND_TASK_FAILED"
		"		COND_RAPTOR_FLIPPED"
	...
	(
		...
		"	Tasks"
		"		TASK_STOP_MOVING					0"
		"		TASK_RAPTOR_GET_PATH_TO_BUGBAIT	0"
		"		TASK_RUN_PATH						0"
		"		TASK_WAIT_FOR_MOVEMENT				0"
		"		TASK_STOP_MOVING					0"
		"		TASK_RAPTOR_FACE_BUGBAIT			0"
		""
		"	Interrupts"
		"		COND_CAN_MELEE_ATTACK1"
		"		COND_SEE_ENEMY"
	...
	(
		...
		"		TASK_PLAY_SEQUENCE		ACTIVITY:ACT_RAPTOR_ZAP_FLIP"
	...
	"		TASK_STOP_MOVING	0"
	"		TASK_RESET_ACTIVITY		0"
	"		TASK_PLAY_SEQUENCE		ACTIVITY:ACT_RAPTOR_FLIP"
	...
	(
		...
		"		TASK_RUN_PATH					0"
		"		TASK_WAIT_FOR_MOVEMENT			0"
		"		TASK_RAPTOR_REACH_FIGHT_GOAL	0"
	...
	(
		...
		"		TASK_RAPTOR_GET_PHYSICS_DANGER_ESCAPE_PATH	1024"
		"		TASK_RUN_PATH								0"
		"		TASK_WAIT_FOR_MOVEMENT						0"
		"		TASK_STOP_MOVING							0"
		""
	...
	(
		...
		"		TASK_RESET_ACTIVITY		0"
		"		TASK_PLAY_SEQUENCE		ACTIVITY:ACT_RAPTOR_POUNCE"
	...
	(
		...
		"		TASK_ANNOUNCE_ATTACK	1"
		"		TASK_RESET_ACTIVITY		0"
		"		TASK_PLAY_SEQUENCE		ACTIVITY:ACT_RAPTOR_POUNCE_MOVING"
	...
	(
		...
		"	Tasks"
		"		TASK_STOP_MOVING	0"
		"		TASK_SET_ACTIVITY			ACTIVITY:ACT_RAPTOR_FALL_TO_GROUND"
		"		TASK_RAPTOR_HOP_OFF_NPC	0"
		"	Interrupts"
	)
	...
	(
		...
		"	Tasks"
		"		TASK_SET_ACTIVITY			ACTIVITY:ACT_RAPTOR_DROWN"
		"		TASK_RAPTOR_DROWN			0"
		""
		"	Interrupts"
	)
	...
	(
		...
		"	Tasks"
		"		TASK_SET_FAIL_SCHEDULE					SCHEDULE:SCHED_RAPTOR_WORKER_RUN_RANDOM"
	...
	(
		...
		"	Tasks"
		"		TASK_SET_FAIL_SCHEDULE			SCHEDULE:SCHED_RAPTOR_TAKE_COVER_FROM_ENEMY"
		"		TASK_SET_TOLERANCE_DISTANCE		48"
		"		TASK_SET_ROUTE_SEARCH_TIME		1"	// Spend 1 second trying to build a path if stuck
	...
	(
		...
		"	Tasks"
		"		TASK_SET_FAIL_SCHEDULE						SCHEDULE:SCHED_FAIL_TAKE_COVER"
		"		TASK_RAPTOR_FIND_COVER_FROM_SAVEPOSITION	0"
		"		TASK_RUN_PATH								0"
		"		TASK_WAIT_FOR_MOVEMENT						0"
		"		TASK_STOP_MOVING							0"
		""
...
//-----------------------------------------------------------------------------
// Purpose: Whether or not the target is a worker class of Velociraptor
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool IsRaptorWorker( CBaseEntity *pEntity )
{
	// Must at least be valid and an Velociraptor
	return ( pEntity != NULL && 
			 pEntity->Classify() == CLASS_RAPTOR && 
			 pEntity->HasSpawnFlags( SF_RAPTOR_WORKER ) &&
			 dynamic_cast<CNPC_Raptor *>(pEntity) != NULL );	// Save this as the last step
}

//-----------------------------------------------------------------------------
// Purpose: Whether or not the entity is a common Velociraptor
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool IsRaptor( CBaseEntity *pEntity )
{
	// Must at least be valid and an Velociraptor
	return ( pEntity != NULL && 
			 pEntity->Classify() == CLASS_RAPTOR && 
...
#ifdef HL2_EPISODIC
//-----------------------------------------------------------------------------
// Purpose: Used by other entities to judge the Velociraptor worker's radius of damage
//-----------------------------------------------------------------------------
float RaptorWorkerBurstRadius( void )
{
	return sk_raptor_worker_burst_radius.GetFloat();
}
#endif // HL2_EPISODIC
