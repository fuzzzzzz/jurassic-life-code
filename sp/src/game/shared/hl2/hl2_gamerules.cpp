...
//JL
ConVar	sk_plr_num_spas12_pellets( "sk_plr_num_spas12_pellets","7", FCVAR_REPLICATED);
ConVar	sk_plr_num_tranqualizer_pellets( "sk_plr_num_tranqualizer_pellets","7", FCVAR_REPLICATED);
...
ConVar  alyx_darkness_force( "alyx_darkness_force", "0", FCVAR_CHEAT | FCVAR_REPLICATED );
	...
	void CHalfLife2::InitDefaultAIRelationships( void )
	{
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_ANTLION,			CLASS_GALLIMIMUS,D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_ANTLION,			CLASS_COMPY,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_ANTLION,			CLASS_RAPTOR,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_ANTLION,			CLASS_CROCODILE,		D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_ANTLION,			CLASS_TREX,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_ANTLION,			CLASS_TRICERATOPS,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BARNACLE,			CLASS_GALLIMIMUS,D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BARNACLE,			CLASS_COMPY,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BULLSEYE,			CLASS_GALLIMIMUS,D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BULLSEYE,			CLASS_COMPY,		D_NU, 0);
		...
		*/
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_PASSIVE,	CLASS_GALLIMIMUS,D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_PASSIVE,	CLASS_COMPY,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_PASSIVE,	CLASS_PIRANHA,		D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_PASSIVE,	CLASS_BRYCON,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_PASSIVE,	CLASS_RAPTOR,		D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_PASSIVE,	CLASS_CROCODILE,		D_FR, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_REBEL,		CLASS_GALLIMIMUS,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_REBEL,		CLASS_COMPY,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_REBEL,		CLASS_PIRANHA,		D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_REBEL,		CLASS_BRYCON,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_REBEL,		CLASS_RAPTOR,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_REBEL,		CLASS_CROCODILE,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE,			CLASS_GALLIMIMUS,D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE,			CLASS_COMPY,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE,			CLASS_RAPTOR,		D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE,			CLASS_CROCODILE,		D_FR, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE_GUNSHIP,		CLASS_GALLIMIMUS,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE_GUNSHIP,		CLASS_COMPY,			D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE_HUNTER,		CLASS_GALLIMIMUS,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE_HUNTER,		CLASS_COMPY,			D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CONSCRIPT,			CLASS_GALLIMIMUS,D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CONSCRIPT,			CLASS_COMPY,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_FLARE,			CLASS_GALLIMIMUS,D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_FLARE,			CLASS_COMPY,		D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_HEADCRAB,			CLASS_COMPY,D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_HEADCRAB,			CLASS_GALLIMIMUS,D_NU, 0);
		...
		*/
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MANHACK,			CLASS_GALLIMIMUS,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MANHACK,			CLASS_COMPY,			D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_METROPOLICE,		CLASS_GALLIMIMUS,D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_METROPOLICE,		CLASS_COMPY,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_METROPOLICE,		CLASS_RAPTOR,		D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_METROPOLICE,		CLASS_CROCODILE,		D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_METROPOLICE,		CLASS_TREX,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_METROPOLICE,		CLASS_TRICERATOPS,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MILITARY,			CLASS_GALLIMIMUS,D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MILITARY,			CLASS_COMPY,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MILITARY,			CLASS_RAPTOR,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MILITARY,			CLASS_CROCODILE,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MISSILE,			CLASS_GALLIMIMUS,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MISSILE,			CLASS_COMPY,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MISSILE,			CLASS_PIRANHA,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MISSILE,			CLASS_BRYCON,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MISSILE,			CLASS_RAPTOR,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MISSILE,			CLASS_CROCODILE,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MISSILE,			CLASS_TREX,				D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MISSILE,			CLASS_TRICERATOPS,		D_HT, 0);
		// ------------------------------------------------------------
		//	> CLASS_NONE
		// ------------------------------------------------------------
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_NONE,				CLASS_GALLIMIMUS,D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_NONE,				CLASS_COMPY,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_NONE,				CLASS_PIRANHA,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_NONE,				CLASS_BRYCON,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_NONE,				CLASS_RAPTOR,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_NONE,				CLASS_CROCODILE,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_NONE,				CLASS_TREX,				D_NU, 0);		
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_NONE,				CLASS_TRICERATOPS,		D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER,			CLASS_GALLIMIMUS,		D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER,			CLASS_COMPY,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER,			CLASS_PIRANHA,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER,			CLASS_BRYCON,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER,			CLASS_RAPTOR,			D_HT, 0);		
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER,			CLASS_CROCODILE,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER,			CLASS_TREX,				D_HT, 0);		
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER,			CLASS_TRICERATOPS,		D_HT, 0);
		// ------------------------------------------------------------
		//	> CLASS_PLAYER_ALLY
		// ------------------------------------------------------------
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY,			CLASS_GALLIMIMUS,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY,			CLASS_COMPY,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY,			CLASS_PIRANHA,			D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY,			CLASS_BRYCON,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY,			CLASS_RAPTOR,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY,			CLASS_CROCODILE,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY,			CLASS_TREX,				D_HT, 0);		
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY,			CLASS_TRICERATOPS,		D_HT, 0);
		// ------------------------------------------------------------
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY_VITAL,	CLASS_GALLIMIMUS,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY_VITAL,	CLASS_COMPY,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY_VITAL,	CLASS_PIRANHA,			D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY_VITAL,	CLASS_BRYCON,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY_VITAL,	CLASS_RAPTOR,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY_VITAL,	CLASS_CROCODILE,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY_VITAL,	CLASS_TREX,				D_HT, 0);		
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY_VITAL,	CLASS_TRICERATOPS,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SCANNER,			CLASS_GALLIMIMUS,D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SCANNER,			CLASS_COMPY,		D_HT, 0);
		// ------------------------------------------------------------
		//	> CLASS_STALKER
		// ------------------------------------------------------------	
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_STALKER,			CLASS_GALLIMIMUS,D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_STALKER,			CLASS_COMPY,		D_NU, 0);
		// ------------------------------------------------------------
		//	> CLASS_VORTIGAUNT
		// ------------------------------------------------------------	
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_VORTIGAUNT,		CLASS_GALLIMIMUS,D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_VORTIGAUNT,		CLASS_COMPY,		D_NU, 0);
		// ------------------------------------------------------------
		//	> CLASS_ZOMBIE
		// ------------------------------------------------------------	
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_ZOMBIE,			CLASS_GALLIMIMUS,D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_ZOMBIE,			CLASS_COMPY,		D_NU, 0);
		// ------------------------------------------------------------
		//	> CLASS_PROTOSNIPER
		// ------------------------------------------------------------	
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PROTOSNIPER,			CLASS_GALLIMIMUS,D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PROTOSNIPER,			CLASS_COMPY,		D_NU, 0);
		// ------------------------------------------------------------
		//	> CLASS_EARTH_FAUNA
		//
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_EARTH_FAUNA,			CLASS_GALLIMIMUS,		D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_EARTH_FAUNA,			CLASS_COMPY,			D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_EARTH_FAUNA,			CLASS_PIRANHA,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_EARTH_FAUNA,			CLASS_BRYCON,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_EARTH_FAUNA,			CLASS_RAPTOR,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_EARTH_FAUNA,			CLASS_CROCODILE,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_EARTH_FAUNA,			CLASS_TREX,				D_NU, 0);		
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_EARTH_FAUNA,			CLASS_TRICERATOPS,		D_LI, 0);
		// ------------------------------------------------------------
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_HACKED_ROLLERMINE,			CLASS_GALLIMIMUS,D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_HACKED_ROLLERMINE,			CLASS_COMPY,		D_NU, 0);


		// ------------------------------------------------------------
		//	> CLASS_GALLIMIMUS
		// ------------------------------------------------------------
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_NONE,				D_NU, 0);			
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_PLAYER,			D_LI, 0);			
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_ANTLION,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_BARNACLE,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_BULLSEYE,			D_NU, 0);	
		//CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,			CLASS_BULLSQUID,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_CITIZEN_PASSIVE,	D_LI, 0);	
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_CITIZEN_REBEL,	D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_COMBINE,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_COMBINE_GUNSHIP,	D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_COMBINE_HUNTER,	D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_CONSCRIPT,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_FLARE,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_HEADCRAB,			D_FR, 0);
		//CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,			CLASS_HOUNDEYE,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_MANHACK,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_METROPOLICE,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_MILITARY,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_SCANNER,			D_NU, 0);		
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_STALKER,			D_NU, 0);		
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_VORTIGAUNT,		D_NU, 0);		
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_ZOMBIE,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_PROTOSNIPER,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_EARTH_FAUNA,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_PLAYER_ALLY,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_PLAYER_ALLY_VITAL,D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_HACKED_ROLLERMINE,D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_GALLIMIMUS,		D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_COMPY,			D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_PIRANHA,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_BRYCON,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_RAPTOR,			D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_CROCODILE,		D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_TREX,				D_HT, 0);		
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_GALLIMIMUS,				CLASS_TRICERATOPS,		D_LI, 0);

		// ------------------------------------------------------------
		//	> CLASS_COMPY
		// ------------------------------------------------------------
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_NONE,				D_NU, 0);			
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_PLAYER,			D_HT, 0);			
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_ANTLION,			D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_BARNACLE,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_BULLSEYE,			D_NU, 0);
		//CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_BULLSQUID,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_CITIZEN_PASSIVE,	D_HT, 0);	
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_CITIZEN_REBEL,	D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_COMBINE,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_COMBINE_GUNSHIP,	D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_COMBINE_HUNTER,	D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_CONSCRIPT,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_FLARE,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_COMPY,			D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_HEADCRAB,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_MANHACK,			D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_METROPOLICE,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_MISSILE,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_EARTH_FAUNA,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_PLAYER_ALLY,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_PLAYER_ALLY_VITAL,D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_GALLIMIMUS,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_PIRANHA,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_BRYCON,			D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_RAPTOR,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_CROCODILE,		D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_TREX,				D_NU, 0);		
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMPY,			CLASS_TRICERATOPS,		D_LI, 0);

		// ------------------------------------------------------------
		//	> CLASS_PIRANHA
		// ------------------------------------------------------------
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PIRANHA,			CLASS_NONE,				D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PIRANHA,			CLASS_PLAYER,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PIRANHA,			CLASS_EARTH_FAUNA,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PIRANHA,			CLASS_GALLIMIMUS,		D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PIRANHA,			CLASS_COMPY,			D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PIRANHA,			CLASS_BRYCON,			D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PIRANHA,			CLASS_PIRANHA,			D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PIRANHA,			CLASS_CROCODILE,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PIRANHA,			CLASS_RAPTOR,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PIRANHA,			CLASS_CITIZEN_PASSIVE,	D_HT, 0);	
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PIRANHA,			CLASS_CITIZEN_REBEL,	D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PIRANHA,			CLASS_PLAYER_ALLY,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PIRANHA,			CLASS_PLAYER_ALLY_VITAL,D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PIRANHA,			CLASS_TREX,				D_NU, 0);		
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PIRANHA,			CLASS_TRICERATOPS,		D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BRYCON,			CLASS_NONE,				D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BRYCON,			CLASS_PLAYER,			D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BRYCON,			CLASS_EARTH_FAUNA,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BRYCON,			CLASS_GALLIMIMUS,		D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BRYCON,			CLASS_COMPY,			D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BRYCON,			CLASS_RAPTOR,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BRYCON,			CLASS_BRYCON,			D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BRYCON,			CLASS_PIRANHA,			D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BRYCON,			CLASS_CROCODILE,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BRYCON,			CLASS_CITIZEN_PASSIVE,	D_FR, 0);	
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BRYCON,			CLASS_CITIZEN_REBEL,	D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BRYCON,			CLASS_PLAYER_ALLY,		D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BRYCON,			CLASS_PLAYER_ALLY_VITAL,D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BRYCON,			CLASS_TREX,				D_NU, 0);		
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BRYCON,			CLASS_TRICERATOPS,		D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_RAPTOR,			CLASS_NONE,				D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_RAPTOR,			CLASS_PLAYER,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_RAPTOR,			CLASS_EARTH_FAUNA,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_RAPTOR,			CLASS_GALLIMIMUS,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_RAPTOR,			CLASS_COMPY,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_RAPTOR,			CLASS_BRYCON,			D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_RAPTOR,			CLASS_PIRANHA,			D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_RAPTOR,			CLASS_RAPTOR,			D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_RAPTOR,			CLASS_CITIZEN_PASSIVE,	D_FR, 0);	
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_RAPTOR,			CLASS_CITIZEN_REBEL,	D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_RAPTOR,			CLASS_PLAYER_ALLY,		D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_RAPTOR,			CLASS_PLAYER_ALLY_VITAL,D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_RAPTOR,			CLASS_ANTLION,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_RAPTOR,			CLASS_CROCODILE,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_RAPTOR,			CLASS_TREX,				D_HT, 0);		
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_RAPTOR,			CLASS_TRICERATOPS,		D_HT, 0);

		// ------------------------------------------------------------
		//	> CLASS_CROCODILE
		// ------------------------------------------------------------

		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CROCODILE,			CLASS_NONE,				D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CROCODILE,			CLASS_PLAYER,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CROCODILE,			CLASS_EARTH_FAUNA,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CROCODILE,			CLASS_GALLIMIMUS,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CROCODILE,			CLASS_COMPY,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CROCODILE,			CLASS_BRYCON,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CROCODILE,			CLASS_PIRANHA,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CROCODILE,			CLASS_RAPTOR,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CROCODILE,			CLASS_CITIZEN_PASSIVE,	D_FR, 0);	
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CROCODILE,			CLASS_CITIZEN_REBEL,	D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CROCODILE,			CLASS_PLAYER_ALLY,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CROCODILE,			CLASS_PLAYER_ALLY_VITAL,D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CROCODILE,			CLASS_ANTLION,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CROCODILE,			CLASS_TREX,				D_NU, 0);		
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CROCODILE,			CLASS_TRICERATOPS,		D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TREX,			CLASS_NONE,				D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TREX,			CLASS_PLAYER,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TREX,			CLASS_EARTH_FAUNA,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TREX,			CLASS_GALLIMIMUS,		D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TREX,			CLASS_COMPY,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TREX,			CLASS_BRYCON,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TREX,			CLASS_PIRANHA,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TREX,			CLASS_RAPTOR,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TREX,			CLASS_CITIZEN_PASSIVE,	D_FR, 0);	
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TREX,			CLASS_CITIZEN_REBEL,	D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TREX,			CLASS_PLAYER_ALLY,		D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TREX,			CLASS_PLAYER_ALLY_VITAL,D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TREX,			CLASS_ANTLION,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TREX,			CLASS_CROCODILE,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TREX,			CLASS_TREX,				D_NU, 0);		
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TREX,			CLASS_TRICERATOPS,		D_HT, 0);

		// ------------------------------------------------------------
		//	> CLASS_TRICERATOPS
		// ------------------------------------------------------------

		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TRICERATOPS,			CLASS_NONE,				D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TRICERATOPS,			CLASS_PLAYER,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TRICERATOPS,			CLASS_EARTH_FAUNA,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TRICERATOPS,			CLASS_GALLIMIMUS,		D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TRICERATOPS,			CLASS_COMPY,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TRICERATOPS,			CLASS_BRYCON,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TRICERATOPS,			CLASS_PIRANHA,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TRICERATOPS,			CLASS_RAPTOR,			D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TRICERATOPS,			CLASS_CITIZEN_PASSIVE,	D_FR, 0);	
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TRICERATOPS,			CLASS_CITIZEN_REBEL,	D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TRICERATOPS,			CLASS_PLAYER_ALLY,		D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TRICERATOPS,			CLASS_PLAYER_ALLY_VITAL,D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TRICERATOPS,			CLASS_ANTLION,			D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TRICERATOPS,			CLASS_CROCODILE,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TRICERATOPS,			CLASS_TREX,				D_HT, 0);		
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_TRICERATOPS,			CLASS_TRICERATOPS,		D_LI, 0);
	...
	const char* CHalfLife2::AIClassText(int classType)
	{
		switch (classType)
		{
			...
			case CLASS_GALLIMIMUS:		return "CLASS_GALLIMIMUS";
			case CLASS_COMPY:			return "CLASS_COMPY";
			case CLASS_BRYCON:			return "CLASS_BRYCON";
			case CLASS_PIRANHA:			return "CLASS_PIRANHA";
			
			// not implemented, just declared here, and the relationship table, must be added too. -red
			case CLASS_RAPTOR:			return "CLASS_RAPTOR";
			//case CLASS_GOAT:			return "CLASS_GOAT";
			case CLASS_TREX:			return "CLASS_TREX";
			case CLASS_TRICERATOPS:		return "CLASS_TRICERATOPS";
			//case CLASS_DILOPHOSAURUS:	return "CLASS_DILOPHOSAURUS";
			//case CLASS_BRACHIOSAURUS:	return "CLASS_BRACHIOSAURUS";
...
bool CHalfLife2::ShouldCollide( int collisionGroup0, int collisionGroup1 )
{
	...
	// JL compy	
	// compy does't collide with other npc  -red
	if ( (collisionGroup0 == COLLISION_GROUP_PLAYER || collisionGroup0 == COLLISION_GROUP_PUSHAWAY ) && ( collisionGroup1 == HL2COLLISION_GROUP_ANTLION) )
		return true;
	// compy does't collide with other npc  -red
	//if ( collisionGroup0 == HL2COLLISION_GROUP_ANTLION && collisionGroup1 == JLCOLLISION_GROUP_COMPY )
	//	return true;

	if ( ( collisionGroup0 == JLCOLLISION_GROUP_COMPY ) && ( collisionGroup1 == JLCOLLISION_GROUP_COMPY ) )
		return true;

	if ( ( collisionGroup0 == COLLISION_GROUP_PLAYER ) && ( collisionGroup1 == JLCOLLISION_GROUP_COMPY ) )
		return true;
	if ( ( collisionGroup0 == COLLISION_GROUP_PLAYER_MOVEMENT ) && ( collisionGroup1 == JLCOLLISION_GROUP_COMPY ) )
		return false;	
	
	// is that working ? i am not sure about is going on here -red
	//if ( (collisionGroup0 == COLLISION_GROUP_PLAYER || collisionGroup1 == JLCOLLISION_GROUP_COMPY)
	//	&&collisionGroup1 == COLLISION_GROUP_PUSHAWAY )
	//	return true;
		
	// JL FISH collision
	if ( collisionGroup0 == COLLISION_GROUP_PLAYER && collisionGroup1 == JLCOLLISION_GROUP_FISH )
		return false;
	if ( collisionGroup0 == JLCOLLISION_GROUP_FISH && collisionGroup1 == COLLISION_GROUP_PLAYER )
		return true;

	// JL Gallimimus

	if ( ( collisionGroup0 == JLCOLLISION_GROUP_COMPY ) && ( collisionGroup1 == JLCOLLISION_GROUP_GALLI ) )
		return false;
		
	if ( (collisionGroup0 == COLLISION_GROUP_PLAYER || collisionGroup1 == JLCOLLISION_GROUP_GALLI)
		&&collisionGroup1 == COLLISION_GROUP_PUSHAWAY )
		return true;
