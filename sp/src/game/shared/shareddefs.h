...
//JL(TH) : Set max to 8 (by deafult 48)
#define MAX_WEAPONS				8	// Max number of weapons available
...
enum PLAYER_ANIM
{
	...
	//JL_PLAYER ANIMATIONS
	/*
	PLAYER_LADDER_START_UP,
	PLAYER_LADDER_START_DOWN,
	PLAYER_LADDER_END_UP,
	PLAYER_LADDER_END_DOWN,
	*/
...
enum
{
	...
	//JL flag
	VGUI_SCREEN_NO_COLOR_CORRECTION = 0x20,
...
//JL(TH) : Def
#define MAX_JL_ITEMS 50
#define MAX_JL_NOTES 1000
