...
BEGIN_VS_SHADER_FLAGS( JL_BlurFilterX, "Help for JL_BlurFilterX", SHADER_NOT_EDITABLE )
	BEGIN_SHADER_PARAMS
	END_SHADER_PARAMS
	...
	SHADER_DRAW
	{
		SHADOW_STATE
		{
			...
			// Pre-cache shaders
			jl_blurfilter_vs20_Static_Index vshIndex;
			pShaderShadow->SetVertexShader( "JL_BlurFilter_vs20", vshIndex.GetIndex() );
