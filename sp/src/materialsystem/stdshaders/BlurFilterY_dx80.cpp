...
DEFINE_FALLBACK_SHADER( JL_BlurFilterY, JL_BlurFilterY_DX80 )

BEGIN_VS_SHADER_FLAGS( JL_BlurFilterY_DX80, "Help for JL_BlurFilterY_DX80", SHADER_NOT_EDITABLE )
	BEGIN_SHADER_PARAMS
	...
	SHADER_DRAW
	{
		SHADOW_STATE
		{
			...
			// Pre-cache shaders
			pShaderShadow->SetVertexShader( "JL_BlurFilter_vs11", 0 );
			pShaderShadow->SetPixelShader( "JL_BlurFilter_ps11", 0 );
