...
#include "JL_cable.inc"

// memdbgon must be the last include file in a .cpp file!!!
#include "tier0/memdbgon.h"

DEFINE_FALLBACK_SHADER( JL_Cable, JL_Cable_DX8 )

BEGIN_VS_SHADER( JL_Cable_DX8, 
	...
	SHADER_DRAW
	{
		SHADOW_STATE
		{
			...
			jl_cable_Static_Index vshIndex;
			pShaderShadow->SetVertexShader( "JL_Cable", vshIndex.GetIndex() );

			pShaderShadow->SetPixelShader( "JL_Cable" );
		...
		DYNAMIC_STATE
		{
			...
			jl_cable_Dynamic_Index vshIndex;
