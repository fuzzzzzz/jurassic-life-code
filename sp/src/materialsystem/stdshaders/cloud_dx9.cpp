...
#include "JL_cloud_vs20.inc"
#include "JL_cloud_ps20.inc"


// memdbgon must be the last include file in a .cpp file!!!
#include "tier0/memdbgon.h"

DEFINE_FALLBACK_SHADER( JL_Cloud, JL_Cloud_dx9 )

BEGIN_VS_SHADER( JL_Cloud_dx9, "Help for JL_Cloud" )
...
*/
	...
	SHADER_DRAW
	{
		SHADOW_STATE
		{
			...
			DECLARE_STATIC_VERTEX_SHADER( jl_cloud_vs20 );
			SET_STATIC_VERTEX_SHADER( jl_cloud_vs20 );

			DECLARE_STATIC_PIXEL_SHADER( jl_cloud_ps20 );
			SET_STATIC_PIXEL_SHADER( jl_cloud_ps20 );
		...
		DYNAMIC_STATE
		{
			...
			DECLARE_DYNAMIC_VERTEX_SHADER( jl_cloud_vs20 );
			SET_DYNAMIC_VERTEX_SHADER( jl_cloud_vs20 );

			DECLARE_DYNAMIC_PIXEL_SHADER( jl_cloud_ps20 );
			SET_DYNAMIC_PIXEL_SHADER( jl_cloud_ps20 );
		}
