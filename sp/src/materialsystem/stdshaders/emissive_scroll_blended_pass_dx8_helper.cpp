...
#include "JL_emissive_scroll_blended_pass_dx8_vs11.inc"
								   ...
								   IShaderShadow* pShaderShadow, EmissiveScrollBlendedPassVars_t &info, VertexCompressionType_t vertexCompression )
{
	SHADOW_STATE
	{
		...
		// Vertex Shader
		jl_emissive_scroll_blended_pass_dx8_vs11_Static_Index vshIndex;
		pShaderShadow->SetVertexShader( "jl_emissive_scroll_blended_pass_dx8_vs11", vshIndex.GetIndex() );

		// Pixel Shader
		pShaderShadow->SetPixelShader( "jl_emissive_scroll_blended_pass_dx8_ps11", 0 );
	...
	DYNAMIC_STATE
	{
		...
		jl_emissive_scroll_blended_pass_dx8_vs11_Dynamic_Index vshIndex;
