...
#include "JL_flesh_interior_blended_pass_dx8_vs11.inc"
								  ...
								  IShaderShadow* pShaderShadow, FleshInteriorBlendedPassVars_t &info, VertexCompressionType_t vertexCompression )
{
	SHADOW_STATE
	{
		...
		// Vertex Shader
		jl_flesh_interior_blended_pass_dx8_vs11_Static_Index vshIndex;
		pShaderShadow->SetVertexShader( "JL_flesh_interior_blended_pass_dx8_vs11", vshIndex.GetIndex() );

		// Pixel Shader
		pShaderShadow->SetPixelShader( "JL_flesh_interior_blended_pass_dx8_ps11", 0 );
	...
	DYNAMIC_STATE
	{
		...
		jl_flesh_interior_blended_pass_dx8_vs11_Dynamic_Index vshIndex;
