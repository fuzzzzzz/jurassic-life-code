...
#include "JL_flesh_interior_blended_pass_vs20.inc"
#include "JL_flesh_interior_blended_pass_ps20.inc"
#include "JL_flesh_interior_blended_pass_ps20b.inc"
								  ...
								  IShaderShadow* pShaderShadow, FleshInteriorBlendedPassVars_t &info, VertexCompressionType_t vertexCompression )
{
	SHADOW_STATE
	{
		...
		// Vertex Shader
		DECLARE_STATIC_VERTEX_SHADER( jl_flesh_interior_blended_pass_vs20 );
		SET_STATIC_VERTEX_SHADER_COMBO( HALFLAMBERT, IS_FLAG_SET( MATERIAL_VAR_HALFLAMBERT ) );
		SET_STATIC_VERTEX_SHADER_COMBO( USE_STATIC_CONTROL_FLOW, bUseStaticControlFlow );
		SET_STATIC_VERTEX_SHADER( jl_flesh_interior_blended_pass_vs20 );

		// Pixel Shader
		if( g_pHardwareConfig->SupportsPixelShaders_2_b() )
		{
			DECLARE_STATIC_PIXEL_SHADER( jl_flesh_interior_blended_pass_ps20b );
			SET_STATIC_PIXEL_SHADER( jl_flesh_interior_blended_pass_ps20b );
		}
		else
		{
			DECLARE_STATIC_PIXEL_SHADER( jl_flesh_interior_blended_pass_ps20 );
			SET_STATIC_PIXEL_SHADER( jl_flesh_interior_blended_pass_ps20 );
		}
	...
	DYNAMIC_STATE
	{
		...
		DECLARE_DYNAMIC_VERTEX_SHADER( jl_flesh_interior_blended_pass_vs20 );
		...
		SET_DYNAMIC_VERTEX_SHADER( jl_flesh_interior_blended_pass_vs20 );
		...
		if( g_pHardwareConfig->SupportsPixelShaders_2_b() )
		{
			DECLARE_DYNAMIC_PIXEL_SHADER( jl_flesh_interior_blended_pass_ps20b );
			SET_DYNAMIC_PIXEL_SHADER( jl_flesh_interior_blended_pass_ps20b );
		}
		else
		{
			DECLARE_DYNAMIC_PIXEL_SHADER( jl_flesh_interior_blended_pass_ps20 );
			SET_DYNAMIC_PIXEL_SHADER( jl_flesh_interior_blended_pass_ps20 );
		}
