...
#include "jl_lightmappedgeneric_decal.inc"
...
BEGIN_VS_SHADER( JL_LightmappedGeneric_Decal,
			  "Help for JL_LightmappedGeneric_Decal" )
	...
	void DrawDecal( IMaterialVar **params, IShaderDynamicAPI *pShaderAPI, IShaderShadow *pShaderShadow )
	{
		if( IsSnapshotting() )
		{
			...
			jl_lightmappedgeneric_decal_Static_Index vshIndex;
			pShaderShadow->SetVertexShader( "JL_LightmappedGeneric_Decal", vshIndex.GetIndex() );
			pShaderShadow->SetPixelShader( "JL_LightmappedGeneric_Decal" );
			FogToFogColor();
		}
		else
		{
			...
			jl_lightmappedgeneric_decal_Dynamic_Index vshIndex;
