...
#include "convar.h"
#include "JL_lightmappedgeneric_ps20.inc"
#include "JL_lightmappedgeneric_vs20.inc"
#include "JL_lightmappedgeneric_ps20b.inc"
...
//		if( hasLightmap )
				...
				if ( g_pHardwareConfig->SupportsPixelShaders_2_b() )
				{
					DECLARE_STATIC_PIXEL_SHADER( jl_lightmappedgeneric_ps20b );
...
#endif
					SET_STATIC_PIXEL_SHADER( jl_lightmappedgeneric_ps20b );
				}
				else
				{
					DECLARE_STATIC_PIXEL_SHADER( jl_lightmappedgeneric_ps20 );
					SET_STATIC_PIXEL_SHADER_COMBO( BASETEXTURE2, hasBaseTexture2 );
					SET_STATIC_PIXEL_SHADER_COMBO( DETAILTEXTURE, hasDetailTexture );
					SET_STATIC_PIXEL_SHADER_COMBO( BUMPMAP,  bumpmap_variant );
					SET_STATIC_PIXEL_SHADER_COMBO( BUMPMAP2, hasBump2 );
					...
					SET_STATIC_PIXEL_SHADER( jl_lightmappedgeneric_ps20 );
				}
	...
	DYNAMIC_STATE
	{
		...
		SET_DYNAMIC_VERTEX_SHADER_CMD( DynamicCmdsOut, jl_lightmappedgeneric_vs20 );
		...
		if ( g_pHardwareConfig->SupportsPixelShaders_2_b() )
		{
			DECLARE_DYNAMIC_PIXEL_SHADER( jl_lightmappedgeneric_ps20b );
			...
			SET_DYNAMIC_PIXEL_SHADER_CMD( DynamicCmdsOut, jl_lightmappedgeneric_ps20b );
		}
		else
		{
			DECLARE_DYNAMIC_PIXEL_SHADER( jl_lightmappedgeneric_ps20 );
			...
			SET_DYNAMIC_PIXEL_SHADER_CMD( DynamicCmdsOut, jl_lightmappedgeneric_ps20 );
		}
