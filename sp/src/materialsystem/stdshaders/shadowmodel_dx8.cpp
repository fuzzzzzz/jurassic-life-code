...
#include "JL_shadowmodel.inc"

// memdbgon must be the last include file in a .cpp file!!!
#include "tier0/memdbgon.h"

DEFINE_FALLBACK_SHADER( JL_ShadowModel, JL_ShadowModel_DX8 )

BEGIN_VS_SHADER_FLAGS( JL_ShadowModel_DX8, "Help for JL_ShadowModel", SHADER_NOT_EDITABLE )
	...
	SHADER_DRAW
	{
		SHADOW_STATE
		{
			...
			jl_shadowmodel_Static_Index vshIndex;
			pShaderShadow->SetVertexShader( "JL_ShadowModel", vshIndex.GetIndex() );

			pShaderShadow->SetPixelShader( "JL_ShadowModel" );
		...
		DYNAMIC_STATE
		{
			...
			jl_shadowmodel_Dynamic_Index vshIndex;
