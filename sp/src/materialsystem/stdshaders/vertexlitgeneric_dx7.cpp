...
DEFINE_FALLBACK_SHADER( JL_VertexLitGeneric, JL_VertexLitGeneric_DX7 )
DEFINE_FALLBACK_SHADER( JL_Skin_DX9, JL_VertexLitGeneric_DX7 )

BEGIN_SHADER( JL_VertexLitGeneric_DX7, 
			  "Help for JL_VertexLitGeneric_DX7" )
