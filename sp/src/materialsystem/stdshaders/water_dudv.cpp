...
#include "JL_waterdudv_vs11.inc"

// memdbgon must be the last include file in a .cpp file!!!
#include "tier0/memdbgon.h"

BEGIN_VS_SHADER( JL_Water_DuDv, "Help for JL_Water_DuDv" )
	...
	SHADER_DRAW
	{
		SHADOW_STATE
		{
			...
			pShaderShadow->SetVertexShader( "JL_WaterDuDv_vs11", 0 );
			pShaderShadow->SetPixelShader( "JL_WaterDuDv_ps11", 0 );
			DisableFog();
		}
		DYNAMIC_STATE
		{
			jl_waterdudv_vs11_Dynamic_Index vshIndex;
