...
//[JL - Parralax mapping
//#include "JL_lightmappedgeneric_vs30.inc"
//#include "JL_worldtwotextureblend_ps30.inc"
//JL]

#include "JL_lightmappedgeneric_vs20.inc"
#include "JL_WorldTwoTextureBlend_ps20.inc"
#include "JL_WorldTwoTextureBlend_ps20b.inc"
...
BEGIN_VS_SHADER( JL_WorldTwoTextureBlend, 
			  "Help for JL_WorldTwoTextureBlend" )
...
/*
	SHADER_FALLBACK
	{
		if( g_pHardwareConfig->GetDXSupportLevel() < 80 )
			return "JL_WorldTwoTextureBlend_DX6";

		if( g_pHardwareConfig->GetDXSupportLevel() < 90 )
			return "JL_WorldTwoTextureBlend_DX8";
...
*/
		...
		IShaderShadow* pShaderShadow, bool hasFlashlight, VertexCompressionType_t vertexCompression )
	{
		...
		SHADOW_STATE
		{
			...
			DECLARE_STATIC_VERTEX_SHADER( jl_lightmappedgeneric_vs20 );
			...
			SET_STATIC_VERTEX_SHADER( jl_lightmappedgeneric_vs20 );


			if ( g_pHardwareConfig->SupportsPixelShaders_2_b() )
			{
				DECLARE_STATIC_PIXEL_SHADER( jl_worldtwotextureblend_ps20b );
				...
				SET_STATIC_PIXEL_SHADER( jl_worldtwotextureblend_ps20b );
			}
			else
			{
				DECLARE_STATIC_PIXEL_SHADER( jl_worldtwotextureblend_ps20 ); //jl_worldtwotextureblend_ps20 );
				SET_STATIC_PIXEL_SHADER_COMBO( DETAILTEXTURE,  hasDetailTexture );
				SET_STATIC_PIXEL_SHADER_COMBO( BUMPMAP,  hasBump );
				SET_STATIC_PIXEL_SHADER_COMBO( DIFFUSEBUMPMAP,  hasDiffuseBumpmap );
				SET_STATIC_PIXEL_SHADER_COMBO( VERTEXCOLOR,  hasVertexColor );
				...
				SET_STATIC_PIXEL_SHADER_COMBO( FLASHLIGHT,  hasFlashlight );
				SET_STATIC_PIXEL_SHADER_COMBO( SEAMLESS,  bSeamlessMapping );
				SET_STATIC_PIXEL_SHADER( jl_worldtwotextureblend_ps20 ); //jl_worldtwotextureblend_ps20 );
			}
		...
		DYNAMIC_STATE
		{
			...
			DECLARE_DYNAMIC_VERTEX_SHADER( jl_lightmappedgeneric_vs20 );
			...
			SET_DYNAMIC_VERTEX_SHADER( jl_lightmappedgeneric_vs20 );
			...
			if ( g_pHardwareConfig->SupportsPixelShaders_2_b() )
			{
				DECLARE_DYNAMIC_PIXEL_SHADER( jl_worldtwotextureblend_ps20b );
				...
				SET_DYNAMIC_PIXEL_SHADER( jl_worldtwotextureblend_ps20b );
			}
			else
			{
				DECLARE_DYNAMIC_PIXEL_SHADER( jl_worldtwotextureblend_ps20 );
				...
				SET_DYNAMIC_PIXEL_SHADER_COMBO( PIXELFOGTYPE, pShaderAPI->GetPixelFogCombo() );
				SET_DYNAMIC_PIXEL_SHADER( jl_worldtwotextureblend_ps20 );
			}
