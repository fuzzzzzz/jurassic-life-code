...
DEFINE_FALLBACK_SHADER( JL_WorldTwoTextureBlend, JL_WorldTwoTextureBlend_DX8 )

BEGIN_VS_SHADER( JL_WorldTwoTextureBlend_DX8, 
			  "Help for JL_WorldTwoTextureBlend_DX8" )
	...
	const char *GetPixelShaderName( IMaterialVar** params, bool bHasBaseTexture, bool bHasDetailTexture )
	{
		...
		{
			if ( bSelfIllum )
				return "JL_WorldTwoTextureBlend_SelfIlluminated";

			return "Jl_WorldTwoTextureBlend";
		}

		return "JL_WorldTwoTextureBlend_DetailAlpha";
	}
