...
DEFINE_FALLBACK_SHADER( JL_WorldVertexTransition, JL_WorldVertexTransition_DX9 )

BEGIN_VS_SHADER( JL_WorldVertexTransition_DX9, "Help for JL_WorldVertexTransition" )
	...
	SHADER_FALLBACK
	{
		if( g_pHardwareConfig->GetDXSupportLevel() < 90 )
			return "JL_WorldVertexTransition_DX8";
