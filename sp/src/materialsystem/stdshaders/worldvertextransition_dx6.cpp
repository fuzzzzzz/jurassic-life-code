...
DEFINE_FALLBACK_SHADER( JL_WorldVertexTransition, JL_WorldVertexTransition_DX6 )

BEGIN_SHADER( JL_WorldVertexTransition_DX6,
			  "Help for JL_WorldVertexTransition_dx6" )
