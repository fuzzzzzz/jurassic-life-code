...
#include "../game/client/jl/ButtonSlot.h"
...
#include "vgui_controls/BlurComboBox.h"
...
//JL
USING_BUILD_FACTORY( HTMLWebKit );
USING_BUILD_FACTORY( ButtonSlot );
USING_BUILD_FACTORY( ImageButton );
USING_BUILD_FACTORY( FakeCursor );
USING_BUILD_FACTORY( LogicImage );
USING_BUILD_FACTORY( LogicImageButton );
USING_BUILD_FACTORY( LogicLabel );
USING_BUILD_FACTORY( VarSlider );
USING_BUILD_FACTORY( BlurComboBox );
